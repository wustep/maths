...
echo "  5. Fill problems/$slug/compute/LEAVES.md from the finite handles in PROBLEM.md."
echo "  6. When the first quest asserts something, write problems/$slug/compute/q1/CLAIM.md."
echo "  7. Before claiming a bound, follow AGENTS.md How to work."
