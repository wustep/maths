...
The smallest published planar five-chromatic unit-distance graph has 509 vertices. Minimality is unknown. Any strictly smaller exact-coordinate 5-chromatic unit-distance graph is a dent.
...
A 4-coloring of the 509-graph would refute the published claim (bigger dent). Do not invent coordinates. Do not claim Hadwiger-Nelson is 5 or 6.

## Tonight's residue (2026-08-17)
