...
## 2026-08-27 — q7, same-day record check (URLs opened this pass)

- [HPS abs, arXiv:2504.18487](https://arxiv.org/abs/2504.18487). Still **v1 only** (submitted 25 Apr 2025). STATES $N_c(Z)<1.1185Z+O(Z^{1/3})$. Does NOT list a v2.
- [HPS v1 abs, arXiv:2504.18487v1](https://arxiv.org/abs/2504.18487v1). Submission history: `[v1]` Fri 25 Apr 2025 16:54:13 UTC only.
- [HPS HTML, 2504.18487v1](https://arxiv.org/html/2504.18487v1). Re-read Theorem 2.2, Remark 2.3, Proposition 2.5, Theorem 4.2, Section 7. STATES the printed leading $1.1185$ and $b(3)<1.1185$. Does NOT prove a coefficient below $1.1185$. Does NOT prove a minimizer of $\beta_3$ has bounded aspect.
- [Nam abs, 1009.2367](https://arxiv.org/abs/1009.2367). Latest v3 (26 Nov 2011). STATES $N_c<1.22Z+3Z^{1/3}$. Does NOT beat $1.1185$ or the notebook $1.1026$.
- [Benguria–González-Brantes abs, 2511.07582](https://arxiv.org/abs/2511.07582). Still v1 (10 Nov 2025). STATES a statistics-independent bound for $Z\ge 12$.
- [2511.07582v1 HTML](https://arxiv.org/html/2511.07582v1). Theorem 1.1 / (2) unchanged: $N<1.4811Z+3.1516Z^{1/3}$ for $Z\ge 12$. Does NOT beat $1.1026$ for fermions.
- [OpenAlex doi:10.48550/arXiv.2504.18487](https://api.openalex.org/works?filter=doi:10.48550/arXiv.2504.18487). STATES `cited_by_count: 0`, id W4416381655.
- [arXiv API, excess-charge / ionization query](https://export.arxiv.org/api/query?search_query=all:%22excess+charge%22+AND+all:atoms+AND+all:ionization&start=0&max_results=15). Five hits, none a later fermionic leading coefficient.

Independent replay this pass: `compute/q6/verify_lift.py` (recon $\gamma$ matches, $1/\gamma<1.1035$, cut$>\gamma$); `compute/q6/verify_rebuild.py` (stdlib $A$ to $10^{-15}$); `compute/q1/hylleraas.py` ($E=-815/1602$, $N_0(1)=2$).

Failed / unchanged: APS PRA 29 full text still not obtained; 2207.08328v2 body still not a record. No paper opened this pass proves $N_c\le Z+C$.

## 2026-08-27 — q8, same-day record check (URLs opened this pass)

- [HPS abs, arXiv:2504.18487](https://arxiv.org/abs/2504.18487). Still **v1 only** (submitted 25 Apr 2025). STATES $N_c(Z)<1.1185Z+O(Z^{1/3})$. Does NOT list a v2.
- [HPS v1 abs, arXiv:2504.18487v1](https://arxiv.org/abs/2504.18487v1). Submission history: `[v1]` only.
- [HPS HTML, 2504.18487v1](https://arxiv.org/html/2504.18487v1). Re-read Theorem 2.2, Remark 2.3, Proposition 2.5, Theorem 4.2, Section 7. STATES the printed leading $1.1185$ and $b(3)<1.1185$. Does NOT prove a coefficient below $1.1185$. Does NOT prove a minimizer of $\beta_3$ has bounded aspect.
- [Nam abs, 1009.2367](https://arxiv.org/abs/1009.2367). Latest v3 (26 Nov 2011). STATES $N_c<1.22Z+3Z^{1/3}$. Does NOT beat $1.1185$ or the notebook $1.1021$.
- [Benguria–González-Brantes abs, 2511.07582](https://arxiv.org/abs/2511.07582). Still v1 (10 Nov 2025). STATES a statistics-independent bound for $Z\ge 12$.
- [2511.07582v1 HTML](https://arxiv.org/html/2511.07582v1). Theorem 1.1 / (2) unchanged: $N<1.4811Z+3.1516Z^{1/3}$ for $Z\ge 12$. Does NOT beat $1.1021$ for fermions.
- [OpenAlex doi:10.48550/arXiv.2504.18487](https://api.openalex.org/works?filter=doi:10.48550/arXiv.2504.18487). STATES `cited_by_count: 0`, id W4416381655.
- [arXiv API, excess-charge / ionization query](https://export.arxiv.org/api/query?search_query=all:%22excess+charge%22+AND+all:atoms+AND+all:ionization&start=0&max_results=15). Five hits, none a later fermionic leading coefficient.

Independent replay this pass: `compute/q7/verify_lift.py` (recon $\gamma$ matches, $1/\gamma<1.1026$, cut$>\gamma$); `compute/q7/verify_rebuild.py` (stdlib $A$ to $10^{-15}$); `compute/q1/hylleraas.py` ($E=-815/1602$, $N_0(1)=2$).

Failed / unchanged: APS PRA 29 full text still not obtained; 2207.08328v2 body still not a record. No paper opened this pass proves $N_c\le Z+C$.

## 2026-08-27 — q9, same-day record check (URLs opened this pass)
...
- [HPS v1 abs, arXiv:2504.18487v1](https://arxiv.org/abs/2504.18487v1). Same page; og:url is `.../2504.18487v1`.
- [HPS HTML, 2504.18487v1](https://arxiv.org/html/2504.18487v1). Re-read Theorem 2.2 / printed $N_c<1.1185Z+4Z^{1/3}$ for $Z\ge 4$. Does NOT prove a coefficient below $1.1185$. Does NOT prove a minimizer of $\beta_3$ has bounded aspect.
- [Nam abs, 1009.2367](https://arxiv.org/abs/1009.2367). STATES $N_c<1.22Z+3Z^{1/3}$. Does NOT beat $1.1185$ or the notebook $1.1020$.
- [Benguria–González-Brantes abs, 2511.07582](https://arxiv.org/abs/2511.07582). Still v1. STATES a statistics-independent bound for $Z\ge 12$.
- [2511.07582v1 HTML](https://arxiv.org/html/2511.07582v1). Theorem 1.1 / (2) unchanged: $N<1.4811Z+3.1516Z^{1/3}$ for $Z\ge 12$. Does NOT beat $1.1020$ for fermions.
- [OpenAlex doi:10.48550/arXiv.2504.18487](https://api.openalex.org/works?filter=doi:10.48550/arXiv.2504.18487). STATES `cited_by_count: 0`, id W4416381655.
- [arXiv API, excess-charge / ionization query](https://export.arxiv.org/api/query?search_query=all:%22excess+charge%22+AND+all:atoms+AND+all:ionization&start=0&max_results=15). Five hits, none a later fermionic leading coefficient.

Independent replay this pass: `compute/q8/verify_lift.py` (recon $\gamma=0.9075071558364936$, $1/\gamma=1.1019196857772997$ prints as $1.1020$, cut $10/11>\gamma$); `compute/q8/verify_rebuild.py` (stdlib $A$ to $10^{-15}$); `compute/q1/hylleraas.py` ($E=-815/1602$, $N_0(1)=2$).

Failed / unchanged: APS PRA 29 full text still not obtained; 2207.08328v2 body still not a record. No paper opened this pass proves $N_c\le Z+C$.

## 2026-08-27 — q10, same-day record check (URLs opened this pass)

- [HPS abs, arXiv:2504.18487](https://arxiv.org/abs/2504.18487). Still **v1 only** (submitted 25 Apr 2025). STATES $N_c(Z)<1.1185Z+O(Z^{1/3})$. Does NOT list a v2. Submission history: `[v1]` Fri 25 Apr 2025 16:54:13 UTC only.
- [HPS v1 abs, arXiv:2504.18487v1](https://arxiv.org/abs/2504.18487v1). Same page; og:url is `.../2504.18487v1`.
- [HPS HTML, 2504.18487v1](https://arxiv.org/html/2504.18487v1). Re-read Theorem 2.2 / printed $N_c<1.1185Z+4Z^{1/3}$ for $Z\ge 4$. Does NOT prove a coefficient below $1.1185$. Does NOT prove a minimizer of $\beta_3$ has bounded aspect.
- [Nam abs, 1009.2367](https://arxiv.org/abs/1009.2367). STATES $N_c<1.22Z+3Z^{1/3}$. Does NOT beat $1.1185$ or the notebook $1.1017$.
- [Benguria–González-Brantes abs, 2511.07582](https://arxiv.org/abs/2511.07582). Still v1. STATES a statistics-independent bound for $Z\ge 12$.
- [2511.07582v1 HTML](https://arxiv.org/html/2511.07582v1). Theorem 1.1 / (2) unchanged: $N<1.4811Z+3.1516Z^{1/3}$ for $Z\ge 12$. Does NOT beat $1.1017$ for fermions.
- [OpenAlex doi:10.48550/arXiv.2504.18487](https://api.openalex.org/works?filter=doi:10.48550/arXiv.2504.18487). STATES `cited_by_count: 0`, id W4416381655.
- [arXiv API, excess-charge / ionization query](https://export.arxiv.org/api/query?search_query=all:%22excess+charge%22+AND+all:atoms+AND+all:ionization&start=0&max_results=15). Five hits, none a later fermionic leading coefficient.

Independent replay this pass: `compute/q9/verify_lift.py` (recon $\gamma=0.9077156846635223$, $1/\gamma=1.1016665426142618$ prints as $1.1017$, cut $10/11>\gamma$); `compute/q9/verify_rebuild.py` (stdlib $A$ to $10^{-15}$); `compute/q1/hylleraas.py` ($E=-815/1602$, $N_0(1)=2$). Do not re-enumerate the stored $17{,}179{,}869{,}183$ faces.

Failed / unchanged: APS PRA 29 full text still not obtained; 2207.08328v2 body still not a record. No paper opened this pass proves $N_c\le Z+C$.

## 2026-08-28 — q11, same-day record check (URLs opened this pass)

- [HPS abs, arXiv:2504.18487](https://arxiv.org/abs/2504.18487). Still **v1 only** (submitted 25 Apr 2025). STATES $N_c(Z)<1.1185Z+O(Z^{1/3})$. Does NOT list a v2. Submission history: `[v1]` Fri 25 Apr 2025 16:54:13 UTC only.
- [HPS v1 abs, arXiv:2504.18487v1](https://arxiv.org/abs/2504.18487v1). Same page; og:url is `.../2504.18487v1`.
- [HPS HTML, 2504.18487v1](https://arxiv.org/html/2504.18487v1). Re-read Theorem 2.2 / printed $N_c<1.1185Z+4Z^{1/3}$ for $Z\ge 4$. Does NOT prove a coefficient below $1.1185$. Does NOT prove a minimizer of $\beta_3$ has bounded aspect.
- [Nam abs, 1009.2367](https://arxiv.org/abs/1009.2367). STATES $N_c<1.22Z+3Z^{1/3}$. Does NOT beat $1.1185$ or the notebook $1.1013$.
- [Benguria–González-Brantes abs, 2511.07582](https://arxiv.org/abs/2511.07582). Still v1. STATES a statistics-independent bound for $Z\ge 12$.
- [2511.07582v1 HTML](https://arxiv.org/html/2511.07582v1). Theorem 1.1 / (2) unchanged: $N<1.4811Z+3.1516Z^{1/3}$ for $Z\ge 12$. Does NOT beat $1.1013$ for fermions.
- [OpenAlex doi:10.48550/arXiv.2504.18487](https://api.openalex.org/works?filter=doi:10.48550/arXiv.2504.18487). STATES `cited_by_count: 0`, id W4416381655.
- [arXiv API, excess-charge / ionization query](https://export.arxiv.org/api/query?search_query=all:%22excess+charge%22+AND+all:atoms+AND+all:ionization&start=0&max_results=15). Five hits, none a later fermionic leading coefficient.

Independent replay this pass: `compute/q10/verify_lift.py` (recon $\gamma=0.908018018752533$, $1/\gamma=1.1012997312254167$ prints as $1.1013$, cut $10/11>\gamma$); `compute/q10/verify_rebuild.py` (stdlib $A$ to $10^{-15}$). Do not re-enumerate the stored $34{,}359{,}738{,}367$ faces.

Failed / unchanged: APS PRA 29 full text still not obtained; 2207.08328v2 body still not a record. No paper opened this pass proves $N_c\le Z+C$.

## 2026-08-29 — q11 wrap, same-day record check (URLs opened this pass)

- [HPS abs, arXiv:2504.18487](https://arxiv.org/abs/2504.18487). Still **v1 only** (submitted 25 Apr 2025). STATES $N_c(Z)<1.1185Z+O(Z^{1/3})$. Does NOT list a v2. Submission history still `[v1]` Fri 25 Apr 2025 only.
- [HPS HTML, 2504.18487v1](https://arxiv.org/html/2504.18487v1). Re-read Theorem 2.2 / printed $N_c<1.1185Z+4Z^{1/3}$ for $Z\ge 4$. Does NOT prove a coefficient below $1.1185$.
- [Nam abs, 1009.2367](https://arxiv.org/abs/1009.2367). Latest v3. STATES $N_c<1.22Z+3Z^{1/3}$. Does NOT beat $1.1013$ or the certified $1.1010$.
- [Benguria–González-Brantes abs, 2511.07582](https://arxiv.org/abs/2511.07582). Still v1. STATES a statistics-independent bound for $Z\ge 12$.
- [2511.07582v1 HTML](https://arxiv.org/html/2511.07582v1). Theorem 1.1 / (2) unchanged: $N<1.4811Z+3.1516Z^{1/3}$ for $Z\ge 12$. Does NOT beat $1.1010$ for fermions.
- [OpenAlex doi:10.48550/arXiv.2504.18487](https://api.openalex.org/works?filter=doi:10.48550/arXiv.2504.18487). STATES `cited_by_count: 0`, id W4416381655.
- [arXiv API, excess-charge / ionization query](https://export.arxiv.org/api/query?search_query=all:%22excess+charge%22+AND+all:atoms+AND+all:ionization&start=0&max_results=15). Five hits, none a later fermionic leading coefficient.

Independent replay this pass: `compute/q11/verify_lift.py` (recon $\gamma=0.9083146735963096$, $1/\gamma=1.1009400476166247$ prints as $1.1010$, cut $10/11>\gamma$); `compute/q11/verify_rebuild.py` (stdlib $A$ to $10^{-15}$); `compute/q11/run_all.sh` exit 0. Faces dump copositive, $\min_mMm_safe>0$, `raise_R10_n36_t0p9117.json` and `lift.json` present. Do not re-enumerate the stored $68{,}719{,}476{,}735$ faces. q10 $n=35$ faces were not re-enumerated.

Failed / unchanged: APS PRA 29 full text still not obtained; 2207.08328v2 body still not a record. No paper opened this pass proves $N_c\le Z+C$.

## 2026-08-29 — q12, leftover record check (URLs opened this pass)

- [HPS abs, arXiv:2504.18487](https://arxiv.org/abs/2504.18487). Still **v1 only** (submitted 25 Apr 2025). STATES $N_c(Z)<1.1185Z+O(Z^{1/3})$. Does NOT list a v2. Submission history: `[v1]` Fri 25 Apr 2025 16:54:13 UTC only. og:url is `https://arxiv.org/abs/2504.18487v1`.
- [HPS v1 abs, arXiv:2504.18487v1](https://arxiv.org/abs/2504.18487v1). Same paper body; still v1 only.
- [HPS HTML, 2504.18487v1](https://arxiv.org/html/2504.18487v1). Re-read Theorem 2.2 / printed $N_c<1.1185Z+4Z^{1/3}$ for $Z\ge 4$. Does NOT prove a coefficient below $1.1185$. Does NOT prove a minimizer of $\beta_3$ has bounded aspect.
...
Independent replay this pass: `compute/q11/verify_lift.py` (recon $\gamma=0.9083146735963096$, $1/\gamma=1.1009400476166247$ prints as $1.1010$, cut $10/11>\gamma$); `compute/q11/verify_rebuild.py` (stdlib $A$ to $10^{-15}$). Do not re-enumerate the stored $68{,}719{,}476{,}735$ faces. q10 $n=35$ faces were not re-enumerated.
