#!/usr/bin/env python3
"""HPS Section 7 chain with the q8 compact γ.

Same arithmetic as q1/tighten_hps.py and q7/tighten_leading.py.
...
def main() -> None:
    ...
    blob = {
        ...
        "source": (
            f"q8 compact R={int(row['R'])} n={int(row['n'])} "
    ...
    print("wrote", out)
    if not (lead_ok and a1_ok and rem_ok and extras_ok and r_ok and beats_q7 and beats_hps):
