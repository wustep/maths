#!/usr/bin/env python3
"""HPS Section 7 chain with the q11 compact γ.

Same arithmetic as q1/tighten_hps.py and q10/tighten_leading.py.
...
def main() -> None:
    ...
    blob = {
        ...
        "source": (
            f"q11 compact R={int(row['R'])} n={int(row['n'])} "
        ...
        "inequalities": [
            {
                "beats": (
                    "q10 leading 1.1013, q9 1.1017, q8 1.1020, q7 1.1021, q6 1.1026, "
            ...
            {
                "beats": "q10 simplified 1.1013 Z + 3.935 Z^{1/3}",
                "range": "Z >= 4",
    ...
    print("beats 1.1013", beats_q10, "beats 1.1017", beats_q9)
    print("wrote", out)
    if not (
        lead_ok and a1_ok and rem_ok and extras_ok and r_ok and beats_q10 and beats_hps
    ):
