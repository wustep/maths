#!/usr/bin/env python3
"""Lieb still gives the best integers at Z=2..6 under the q10 envelope.

A leading coefficient above 1 cannot bound N0(Z)-Z. The simplified
q10 form N_c < 1.1013 Z + 3.935 Z^{1/3} sits above 2Z+1 on this
...
def main() -> None:
        ...
        rows.append(
            {
                ...
                "q10_1.1013_3.935": hps,
                "Nam_1.22_3": nam,
                "q10_excludes_new_integer": new_int,
            }
        )
    blob = {
        "status": "residue",
        "reason": (
            ...
            "The q10 simplified envelope sits above 2Z+1 there. A leading "
    ...
    if any_new:
        raise SystemExit("smallz.py unexpected: q10 envelope beats Lieb integers")
