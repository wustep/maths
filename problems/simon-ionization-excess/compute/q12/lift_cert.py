#!/usr/bin/env python3
"""Assemble the q12 leading-coefficient certificate.

A dent of q11's 1.1010 (and of printed HPS 1.1185) if every check passes.
"""
...
def main() -> None:
    ...
    checks = {
        ...
        "leading_beats_1.1010": leading["checks"]["beats_1.1010"],
        "leading_beats_1.1013": leading["checks"]["beats_1.1013"],
        "leading_beats_1.1017": leading["checks"]["beats_1.1017"],
        "leading_beats_1.1020": leading["checks"]["beats_1.1020"],
        "leading_beats_1.1021": leading["checks"]["beats_1.1021"],
    ...
    blob = {
        ...
        "is_new_bound": ok,
        "beats_1.1010": bool(ok and leading["checks"]["beats_1.1010"]),
        "beats_1.1013": bool(ok and leading["checks"]["beats_1.1013"]),
        "beats_1.1017": bool(ok and leading["checks"]["beats_1.1017"]),
        "beats_1.1020": bool(ok and leading["checks"]["beats_1.1020"]),
        "beats_1.1021": bool(ok and leading["checks"]["beats_1.1021"]),
