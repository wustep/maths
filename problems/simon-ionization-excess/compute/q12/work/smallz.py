#!/usr/bin/env python3
"""Lieb still gives the best integers at Z=2..6 under the q11 envelope.

A leading coefficient above 1 cannot bound N0(Z)-Z. The simplified
q11 form N_c < 1.1010 Z + 3.934 Z^{1/3} sits above 2Z+1 on this
...
def main() -> None:
        ...
        rows.append(
            {
                ...
                "q11_1.1010_3.934": hps,
                "Nam_1.22_3": nam,
                "q11_excludes_new_integer": new_int,
            }
        )
    blob = {
        "status": "residue",
        "reason": (
            ...
            "The q11 simplified envelope sits above 2Z+1 there. A leading "
    ...
    if any_new:
        raise SystemExit("smallz.py unexpected: q11 envelope beats Lieb integers")
