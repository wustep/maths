#!/usr/bin/env python3
"""HPS Section 7 chain with the q7 compact γ.

Same arithmetic as q1/tighten_hps.py and q6/tighten_leading.py.
...
def main() -> None:
    ...
    blob = {
        ...
        "source": (
            f"q7 compact R={int(row['R'])} n={int(row['n'])} "
        ...
        "inequalities": [
            {
                "beats": "q6 leading 1.1026, q5 1.1035, q4 1.1057, q3 1.1118, and HPS printed 1.1185",
                "range": "Z >= 4",
                "inequality": (
            ...
            {
                "beats": "q6 simplified 1.1026 Z + 3.938 Z^{1/3}",
                "range": "Z >= 4",
    ...
    print("beats 1.1026", beats_q6, "beats 1.1035", beats_q5)
    print("wrote", out)
    if not (lead_ok and a1_ok and rem_ok and extras_ok and r_ok and beats_q6 and beats_hps):
