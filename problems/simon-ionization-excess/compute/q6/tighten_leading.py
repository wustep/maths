#!/usr/bin/env python3
"""HPS Section 7 chain with the q6 compact γ.

Same arithmetic as q1/tighten_hps.py and q5/tighten_leading.py.
...
def main() -> None:
    ...
    blob = {
        ...
        "source": (
            f"q6 compact R={int(row['R'])} n={int(row['n'])} "
        ...
        "inequalities": [
            {
                "beats": "q5 leading 1.1035, q4 1.1057, q3 1.1118, and HPS printed 1.1185",
                "range": "Z >= 4",
                "inequality": (
            ...
            {
                "beats": "q5 simplified 1.1035 Z + 3.941 Z^{1/3}",
                "range": "Z >= 4",
    ...
    print("beats 1.1035", beats_q5, "beats 1.1057", beats_q4)
    print("wrote", out)
    if not (lead_ok and a1_ok and rem_ok and extras_ok and r_ok and beats_q5 and beats_hps):
