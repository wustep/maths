#!/usr/bin/env python3
"""Lieb still gives the best integers at Z=2..6 under the q5 envelope.

A leading coefficient above 1 cannot bound N0(Z)-Z. The simplified
q5 form N_c < 1.1035 Z + 3.941 Z^{1/3} sits above 2Z+1 on this
...
def main() -> None:
        ...
        rows.append(
            {
                ...
                "q5_1.1035_3.941": hps,
                "Nam_1.22_3": nam,
                "q5_excludes_new_integer": new_int,
            }
        )
    blob = {
        "status": "residue",
        "reason": (
            ...
            "The q5 simplified envelope sits above 2Z+1 there. A leading "
    ...
    if any_new:
        raise SystemExit("smallz.py unexpected: q5 envelope beats Lieb integers")
