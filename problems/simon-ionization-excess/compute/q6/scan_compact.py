...
beat printed 1.1035. A predicted γ is only a dent after faces say
...
def main() -> None:
        ...
        rows.append(
            {
                ...
                "split_gamma": split,
                "split_inv": split_inv,
                "beats_1.1035_if_certified": bool(split_inv < Q5_LEAD),
    ...
    feasible = [
        r
        for r in rows
        if r["beats_1.1035_if_certified"]
        and r["cut_ge_gamma"]
        and r["n"] <= 32
        and r["R"] == 10.0
    ]
    ...
    if best:
        ...
        print("no predicted R=10 n<=32 row beats 1.1035")
    print("wrote", path)
