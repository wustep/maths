#!/usr/bin/env python3
"""HPS Section 7 chain with the q10 compact γ.

Same arithmetic as q1/tighten_hps.py and q9/tighten_leading.py.
...
def main() -> None:
    ...
    blob = {
        ...
        "source": (
            f"q10 compact R={int(row['R'])} n={int(row['n'])} "
        ...
        "inequalities": [
            {
                "beats": (
                    "q9 leading 1.1017, q8 1.1020, q7 1.1021, q6 1.1026, "
            ...
            {
                "beats": "q9 simplified 1.1017 Z + 3.936 Z^{1/3}",
                "range": "Z >= 4",
    ...
    print("beats 1.1017", beats_q9, "beats 1.1020", beats_q8)
    print("wrote", out)
    if not (
        lead_ok and a1_ok and rem_ok and extras_ok and r_ok and beats_q9 and beats_hps
    ):
