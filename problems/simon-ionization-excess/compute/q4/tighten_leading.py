#!/usr/bin/env python3
"""HPS Section 7 chain with the q4 compact γ.

Same arithmetic as q1/tighten_hps.py and q3/tighten_leading.py.
...
def main() -> None:
    ...
    blob = {
        ...
        "source": (
            f"q4 compact R={int(row['R'])} n={int(row['n'])} "
        ...
        "inequalities": [
            {
                "beats": "q3 leading 1.1118 and HPS printed 1.1185",
                "range": "Z >= 4",
                "inequality": (
            ...
            {
                "beats": "q3 simplified 1.1118 Z + 3.966 Z^{1/3}",
                "range": "Z >= 4",
    ...
    print("beats 1.1118", beats_q3, "beats 1.108741", beats_r4)
    print("wrote", out)
    if not (lead_ok and a1_ok and rem_ok and extras_ok and r_ok and beats_q3 and beats_hps):
