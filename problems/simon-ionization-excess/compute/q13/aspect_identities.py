...
def main() -> None:
    ...
    blob = {
        ...
        "beats_1.1010": bool(leading < mpf("1.1010")),
        "beats_1.1013": bool(leading < mpf("1.1013")),
        "beats_1.1017": bool(leading < mpf("1.1017")),
        "beats_1.1020": bool(leading < mpf("1.1020")),
    ...
    print("wrote", out)
    if not (ok and cut_beats and leading < mpf("1.1010")):
