#!/usr/bin/env python3
"""HPS Section 7 chain with the q9 compact γ.

Same arithmetic as q1/tighten_hps.py and q8/tighten_leading.py.
...
def main() -> None:
    ...
    blob = {
        ...
        "source": (
            f"q9 compact R={int(row['R'])} n={int(row['n'])} "
        ...
        "inequalities": [
            {
                "beats": "q8 leading 1.1020, q7 1.1021, q6 1.1026, q5 1.1035, q4 1.1057, q3 1.1118, and HPS printed 1.1185",
                "range": "Z >= 4",
                "inequality": (
            ...
            {
                "beats": "q8 simplified 1.1020 Z + 3.937 Z^{1/3}",
                "range": "Z >= 4",
    ...
    print("beats 1.1020", beats_q8, "beats 1.1021", beats_q7)
    print("wrote", out)
    if not (lead_ok and a1_ok and rem_ok and extras_ok and r_ok and beats_q8 and beats_hps):
