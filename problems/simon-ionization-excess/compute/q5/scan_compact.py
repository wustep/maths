...
beat printed 1.1057. A predicted γ is only a dent after faces say
...
def main() -> None:
        ...
        rows.append(
            {
                ...
                "split_gamma": split,
                "split_inv": split_inv,
                "beats_1.1057_if_certified": bool(split_inv < Q4_LEAD),
    ...
    feasible = [
        r
        for r in rows
        if r["beats_1.1057_if_certified"] and r["cut_ge_gamma"] and r["n"] <= 30
    ]
    ...
    if best:
        ...
        print("no predicted row beats 1.1057")
    print("wrote", path)
