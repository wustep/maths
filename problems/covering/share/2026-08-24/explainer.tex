...
Both verifiers were written by the same person in one session, so they
are not the work of two people. The programs share no code and differ
in language, algorithm, and parser. A third program, kept outside
