...
\texttt{PLACEHOLDER}. Every number is re-checked from the files in that pin.
\end{abstract}
...
\url{https://github.com/wustep/maths/tree/PLACEHOLDER/problems/covering/share/2026-08-24/result}
and
\href{https://github.com/wustep/maths/blob/PLACEHOLDER/problems/covering/share/2026-08-24/result/run_all.sh}{\texttt{result/run\_all.sh}}.
