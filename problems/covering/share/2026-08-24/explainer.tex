...
\author{Stephen Wu}
\date{16 August 2026, language revised 24 August 2026}

\begin{document}
\maketitle

\paragraph{Computation.}
Grok Bot (Maths) orchestrated the campaign; GPT-5.6 Sol found the
50-column matrix by simulated annealing; Claude Opus 5 found the
10-block $(2,0)$-partition, implemented $\mathrm{QM}_2^2$, and wrote
the two verifiers; Claude Fable 5 drafted visitor prose. Stephen Wu
set the target and the verification rule.
