...
\texttt{9a3d372b6f5385507e73d51246677e492746ed10}. Every number is re-checked from the files in that pin.
\end{abstract}
...
$e^{-\Delta/T}$ (Metropolis). With a fixed xorshift64 state, the first
run of the script reached covering radius $2$ at proposal
$3{,}600{,}281$.
...
The anneal produced only the column set. A separate search produced the
$10$-block $(2,0)$-partition of Table~\ref{tab:part}. That search code
is not in the repository; the artifact is
\path{result/data/partition_p10.json}. The $821$ syndromes with a unique
pair force their two columns into distinct blocks, so most of a
partition is constrained before search. Checking a candidate is one
pass over the $1276$ sums of at most two columns. Ten blocks is small
enough for Construction $\mathrm{QM}_2^2$ at both $m=4$ and $m=5$.

\subsection{The check}

Construction $\mathrm{QM}_2^2$ was implemented from (4.2) and (4.4)
of~\cite{DMP2025}. The $m=4$ and $m=5$ outputs were enumerated. The two
opposite verifiers of Section~\ref{sec:verif} re-derive the columns from
the matrix text and use the partition file for block labels only. After
they agreed, a third program outside the repository was run once. The
covering radius of $\HH$ is that finite check, not a property of the
annealing path.
...
Clone the public repository, check out commit \texttt{9a3d372b6f5385507e73d51246677e492746ed10}, and run
the pipeline from this pin:
\begin{verbatim}
git clone https://github.com/wustep/maths.git
cd maths
git checkout 9a3d372b6f5385507e73d51246677e492746ed10
...
\url{https://github.com/wustep/maths/tree/9a3d372b6f5385507e73d51246677e492746ed10/problems/covering/share/2026-08-24/result}
and
\href{https://github.com/wustep/maths/blob/9a3d372b6f5385507e73d51246677e492746ed10/problems/covering/share/2026-08-24/result/run_all.sh}{\texttt{result/run\_all.sh}}.
...
\texttt{problems/covering/share/2026-08-24/} at commit
\texttt{9a3d372b6f5385507e73d51246677e492746ed10}.
