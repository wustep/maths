...
\begin{itemize}\setlength{\itemsep}{0.15ex}\setlength{\parsep}{0pt}
\item Grok Bot orchestrated the campaign.
\item GPT-5.6 Sol found the 50-column matrix by simulated annealing.
\item Claude Opus 5 found the 10-block $(2,0)$-partition, implemented
$\mathrm{QM}_2^2$, and wrote the two verifiers.
\end{itemize}
