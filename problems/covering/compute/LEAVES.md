...
| radius2-r10-n49-local-switch | q14 | residue | All 1,194,375 two-delete/one-add candidates have at least 9 holes; no three-delete/two-add switch covers all syndromes. Local to the 50-set; $n=49$ remains open. |
