...
- These matrices differ from the ones in `_reference/data/` (the indicator allocation is a free choice) and both verify — two distinct witnesses at each \(r\), not one.
