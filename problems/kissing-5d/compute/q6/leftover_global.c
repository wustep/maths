/* Global leftover-tight extras B&B with a 4-star hosted prune.

 * q6 emptied every 4-star leftover host.  A remaining leftover 41-set
 * has U not contained in any 4-star union.  If the maximum possible
 * union of a branch sits in a 4-star, prune.
 *
 * Usage: ./leftover_global [target] [node_limit]
...
static void write_code41(int rsz, const int *stack, u64 U)
{
    ...
    fprintf(f, "  \"source\": \"q6 leftover_global.c\",\n");
...
int main(int argc, char **argv)
{
    ...
    printf("  \"comment\": \"leftover-tight extras B&B; prune if grow sits in a 4-star\"\n");
    printf("}\n");
    return 0;
}
