...
## 2026-08-27 — wrap re-open (leftover through n=125)

Opened again before wrapping leftover SAT past n=124.
...
## 2026-08-27 — wrap re-open (leftover through n=126)

Opened again before wrapping leftover SAT past n=125.
...
## 2026-08-27 — wrap re-open (leftover through n=128)

Opened again before wrapping leftover SAT past n=127.
...
## 2026-08-27 — wrap re-open (leftover through n=129)

Opened again before wrapping leftover SAT past n=128.
...
## 2026-08-27 — wrap re-open (leftover through n=130)

Opened again before wrapping leftover SAT past n=129.
...
## 2026-08-27 — wrap re-open (leftover through n=131)

Opened again before wrapping leftover SAT past n=130.
...
- https://arxiv.org/abs/2402.16776 — Cheng–Keevash. Path-length bounds that *use* HKN 0.3465n (their Theorem 9); they do not replace it.
- https://arxiv.org/html/2402.16776 — Theorem 9 quotes HKN 0.3465n.
- https://www.proofatlas.ai/collaboration/caccetta-haggkvist-conjecture/ — status page opened; no published unrestricted c below HKN 0.3465.

Failed lookup: no later Combinatorica replacement of HKN 0.3465. Do not treat 0.3388 as published.

## 2026-08-27 — wrap re-open (leftover through n=132)

Opened again before wrapping leftover SAT past n=131.

- https://arxiv.org/abs/0908.2791 — Hladký–Král'–Norin v4, 22 Feb 2016. Abstract: every n-vertex digraph of minimum out-degree 0.3465n contains an oriented triangle. Journal reference Combinatorica 37 (2017). No v5.
- https://arxiv.org/html/0908.2791v4 — Theorem 1.2 is the 0.3465n statement. Closing remark: de Joannis de Verclos–Sereni–Volec 0.3388 in March 2014 by F₆ (personal communication).
- https://arxiv.org/abs/0909.2468 — Chen–Karson–Liu–Shen. Theorem 2.5: if G is 3-free then β(G) < 0.8616 γ(G), with μ=0.16065.
- https://export.arxiv.org/api/query?search_query=all:Caccetta+AND+all:Haggkvist&sortBy=submittedDate&sortOrder=descending&max_results=10 — 10 hits. Newest unrestricted-looking items are still 2405.17797 and 2402.16776v4. No post-2017 paper in that list states a published unrestricted c < 0.3465.
- https://arxiv.org/abs/2405.17797 — Mezher–Daamouch. Restricted: a special case of Caccetta–Häggkvist on 7-anti-transitive oriented graphs. No unrestricted numerical c.
- https://arxiv.org/abs/2402.16776 — Cheng–Keevash. Path-length bounds that use HKN 0.3465n (their Theorem 9); they do not replace it.

Failed lookup: no later Combinatorica replacement of HKN 0.3465. Do not treat 0.3388 as published.

## 2026-08-28 — wrap re-open (leftover through n=133)

Opened again before wrapping leftover SAT past n=132.

- https://arxiv.org/abs/0908.2791 — Hladký–Král'–Norin v4, 22 Feb 2016. Abstract: every n-vertex digraph of minimum out-degree 0.3465n contains an oriented triangle. Journal reference Combinatorica 37 (2017). No v5.
- https://arxiv.org/html/0908.2791v4 — Theorem 1.2 is the 0.3465n statement. Closing remark: de Joannis de Verclos–Sereni–Volec 0.3388 in March 2014 by F₆.
- https://arxiv.org/abs/0909.2468 — Chen–Karson–Liu–Shen. Abstract and Theorem 2.5: if G is 3-free then β(G) < 0.8616 γ(G), with μ=0.16065.
- https://export.arxiv.org/api/query?search_query=all:Caccetta+AND+all:Haggkvist&sortBy=submittedDate&sortOrder=descending&max_results=10 — 10 hits. Newest unrestricted-looking items are still 2405.17797 and 2402.16776v4. No post-2017 paper in that list states a published unrestricted c < 0.3465.
- https://arxiv.org/abs/2405.17797 — Mezher–Daamouch. Restricted: a special case of Caccetta–Häggkvist on 7-anti-transitive oriented graphs. No unrestricted numerical c.
- https://arxiv.org/abs/2402.16776 — Cheng–Keevash. Path-length bounds that use the Caccetta–Häggkvist setting; they do not replace HKN 0.3465.

Failed lookup: no later Combinatorica replacement of HKN 0.3465. Do not treat 0.3388 as published.

## 2026-08-28 — wrap re-open (leftover through n=134)

Opened again before wrapping leftover SAT past n=133.
...
Failed lookup: export.arxiv.org Caccetta+Haggkvist search returned HTTP 500 this session. No later Combinatorica replacement of HKN 0.3465 found on the abs pages opened above. Do not treat 0.3388 as published.

## 2026-08-28 — leftover from n=135 (q26 start)

Opened before hunting leftover SAT past n=134.

- https://arxiv.org/abs/0908.2791 — Hladký–Král'–Norin v4, 22 Feb 2016. Abstract: every n-vertex digraph of minimum out-degree 0.3465n contains an oriented triangle. Journal reference Combinatorica 37 (2017). No v5.
- https://arxiv.org/html/0908.2791v4 — Theorem 1.2 is the 0.3465n statement. Closing remark: de Joannis de Verclos–Sereni–Volec 0.3388 in March 2014 by F₆ (personal communication); DHP 0.88 / Shen 0.865 only produce a tiny decrease in Theorem 1.2.
- https://arxiv.org/abs/0909.2468 — Chen–Karson–Liu–Shen. Abstract writes β ≤ 0.8616 γ. The same page includes Theorem 2.5: if G is 3-free then β(G) < 0.8616 γ(G), with μ=0.16065. Uses HKN 0.3465 as the current unrestricted triangle number.
- https://arxiv.org/abs/2102.12830 — Grzesik–Volec v2, 18 Jan 2024. Semidegree thresholds for directed cycles of length ≠ 3. Does not replace the unrestricted triangle threshold.
- https://arxiv.org/abs/2402.16776 — Cheng–Keevash v4, 21 Aug 2024. Path-length bounds that use HKN 0.3465n; they do not replace it.
- https://arxiv.org/abs/2405.17797 — Mezher–Daamouch. Restricted: a special case of Caccetta–Häggkvist on 7-anti-transitive oriented graphs (via Seymour vertices). No unrestricted numerical c.

Failed lookup: no later Combinatorica replacement of HKN 0.3465. Do not treat 0.3388 as published.

## 2026-08-28 — leftover from n=136 (q27 start)

Opened before hunting leftover SAT past n=135.
...
## 2026-08-28 — leftover from n=137 (q28 start)

Opened before hunting leftover SAT past n=136.
...
## 2026-08-28 — leftover from n=138 (q29 start)

Opened before hunting leftover SAT past n=137.
...
## 2026-08-28 — leftover from n=139 (q30 start)

Opened before hunting leftover SAT past n=138.
...
## 2026-08-28 — leftover from n=140 (q31 start)

Opened before hunting leftover SAT past n=139.

- https://arxiv.org/abs/0908.2791 — Hladký–Král'–Norin v4, 22 Feb 2016. Abstract: every n-vertex digraph of minimum out-degree 0.3465n contains an oriented triangle. Journal reference Combinatorica 37 (2017). No v5.
- https://arxiv.org/html/0908.2791v4 — Theorem 1.2 is the 0.3465n statement. Closing remark: de Joannis de Verclos–Sereni–Volec 0.3388 in March 2014 by F₆ (personal communication); DHP 0.88 / Shen 0.865 only produce a tiny decrease in Theorem 1.2.
- https://arxiv.org/abs/0909.2468 — Chen–Karson–Liu–Shen. Abstract writes β ≤ 0.8616 γ. The same page includes Theorem 2.5: if G is 3-free then β(G) < 0.8616 γ(G), with μ=0.16065. Uses HKN 0.3465 as the current unrestricted triangle number.
- https://arxiv.org/abs/2102.12830 — Grzesik–Volec v2, 18 Jan 2024. Semidegree thresholds for directed cycles of length ≠ 3. Does not replace the unrestricted triangle threshold.
- https://arxiv.org/abs/2402.16776 — Cheng–Keevash v4, 21 Aug 2024. Path-length bounds that use HKN 0.3465n (their Theorem 9); they do not replace it.
- https://arxiv.org/abs/2405.17797 — Mezher–Daamouch. Restricted: a special case of Caccetta–Häggkvist on 7-anti-transitive oriented graphs (via Seymour vertices). No unrestricted numerical c.

Failed lookup: no later Combinatorica replacement of HKN 0.3465. Do not treat 0.3388 as published.

## 2026-08-28 — leftover from n=141 (q32 start)

Opened before hunting leftover SAT past n=140.
...
## 2026-08-28 — leftover from n=143 (q34 start)

Opened before hunting leftover SAT past n=142.
...
- https://arxiv.org/abs/0909.2468 — Chen–Karson–Liu–Shen. Abstract writes β ≤ 0.8616 γ. Theorem 2.5: if G is 3-free then β(G) < 0.8616 γ(G), with μ=0.16065. Uses HKN 0.3465 as the current unrestricted triangle number.
- https://arxiv.org/abs/2102.12830 — Grzesik–Volec v2, 18 Jan 2024. Semidegree thresholds for directed cycles of length ≠ 3. Theorem 2.2 quotes HKN 0.3465; bibliography [18] is the 0.3388 personal communication. Does not replace the unrestricted triangle threshold.
...
## 2026-08-28 — leftover from n=145 (q35 start)

Opened before hunting leftover SAT past n=144.
...
## 2026-08-29 — leftover from n=146 (q36 start)

Opened before hunting leftover SAT past n=145.
...
## 2026-08-29 — leftover from n=147 (q37 start)

Opened before hunting leftover SAT past n=146.
...
## 2026-08-29 — leftover from n=149 (q39 start)

Opened before hunting leftover SAT past n=148.

- https://arxiv.org/abs/0908.2791 — Hladký–Král'–Norin v4, 22 Feb 2016. Abstract and Theorem 1.2: every n-vertex digraph of minimum out-degree 0.3465n contains an oriented triangle. Journal reference Combinatorica 37 (2017). No v5.
- https://arxiv.org/html/0908.2791v4 — Theorem 3.3: max δα(Ψ) < 0.3465 on Hom⁺ of the triangle-free flag algebra. Closing remark: de Joannis de Verclos–Sereni–Volec 0.3388 in March 2014 by F₆ (personal communication); DHP 0.88 / Shen 0.865 only produce a tiny decrease in Theorem 1.2.
- https://arxiv.org/abs/0909.2468 — Chen–Karson–Liu–Shen. Abstract writes β ≤ 0.8616 γ. Theorem 2.5: if G is 3-free then β(G) < 0.8616 γ(G), with μ=0.16065. Uses HKN 0.3465 as the current unrestricted triangle number.
- https://arxiv.org/abs/2102.12830 — Grzesik–Volec v2, 18 Jan 2024. Semidegree thresholds for directed cycles of length ≠ 3. Still quotes HKN 0.3465 as the published unrestricted triangle bound and mentions 0.3388 only as a personal communication. Does not replace the unrestricted triangle threshold.
- https://arxiv.org/abs/2402.16776 — Cheng–Keevash v4, 21 Aug 2024. Path-length bounds. Theorem 9 quotes HKN 0.3465n as the triangle-case input; they do not replace it.
- https://arxiv.org/abs/2405.17797 — Mezher–Daamouch. Restricted: a special case of Caccetta–Häggkvist on 7-anti-transitive oriented graphs (via Seymour vertices). No unrestricted numerical c.

Failed lookup: no later Combinatorica replacement of HKN 0.3465. Do not treat 0.3388 as published.

## 2026-08-29 — leftover from n=150 (q40 start)

Opened before hunting leftover SAT past n=149.
...
## 2026-08-29 — leftover from n=151 (q41 start)

Opened before hunting leftover SAT past n=150.
...
## 2026-08-29 — leftover from n=152 (q42 start)

Opened before hunting leftover SAT past n=151.

- https://arxiv.org/abs/0908.2791 — Hladký–Král'–Norin. Abstract and Theorem 1.2: every n-vertex digraph of minimum out-degree 0.3465n contains an oriented triangle. Improves Hamburger–Haxell–Kostochka 0.3532n.
- https://arxiv.org/abs/0908.2791v4 and https://arxiv.org/html/0908.2791v4 — same text. Theorem 3.3: max δα(Ψ) < 0.3465 on Hom⁺ of the triangle-free flag algebra. Closing remark: de Joannis de Verclos–Sereni–Volec 0.3388 in March 2014 by F₆ (personal communication); DHP 0.88 / Shen 0.865 only produce a tiny decrease in Theorem 1.2.
- https://arxiv.org/abs/0909.2468 — Chen–Karson–Liu–Shen. Abstract writes β ≤ 0.8616 γ. Theorem 2.5: if G is 3-free then β(G) < 0.8616 γ(G), with μ=0.16065. Uses HKN 0.3465 as the current unrestricted triangle number.
- https://arxiv.org/abs/2102.12830 — Grzesik–Volec. Semidegree thresholds for directed cycles of length ≠ 3. Still quotes HKN 0.3465 as the published unrestricted triangle bound and mentions 0.3388 only as a personal communication. Does not replace the unrestricted triangle threshold.
- https://arxiv.org/abs/2402.16776 — Cheng–Keevash. Path-length bounds. Theorem 9 quotes HKN 0.3465n as the triangle-case input; they do not replace it.
- https://arxiv.org/abs/2405.17797 — Mezher–Daamouch. Restricted: a special case of Caccetta–Häggkvist on 7-anti-transitive oriented graphs (via Seymour vertices). No unrestricted numerical c.

Failed lookup: no later Combinatorica replacement of HKN 0.3465. Do not treat 0.3388 as published.

## 2026-08-29 — leftover from n=153 (q43 start)

Opened before hunting leftover SAT past n=152.
