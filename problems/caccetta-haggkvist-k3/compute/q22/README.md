# Leftover exact holes from n=131

After the q21 pigeonhole certificates through n=130, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=131, δ⁺=44.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=131
(42 cubes, k=44..85). After n=72 the leftover n are consecutive.
The first remaining hole is n=132, δ⁺=44.
