# Leftover exact holes from n=137

After the q27 pigeonhole certificates through n=136, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=137, δ⁺=46.
...
Those cubes are not yet stored at leftover n=137. After n=72 the
leftover n are consecutive. The first remaining hole is n=137,
