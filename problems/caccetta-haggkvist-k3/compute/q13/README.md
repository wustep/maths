# Leftover exact holes from n=122

After the q12 pigeonhole certificates through n=121, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=122, δ⁺=41.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=122
(39 cubes, k=41..79). After n=72 the leftover n are consecutive.
The first remaining hole is n=123, δ⁺=41.
