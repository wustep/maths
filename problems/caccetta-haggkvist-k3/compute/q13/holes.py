...
# Exact orders already stored in q1 / q2 / q3 / q4 / q5 / q6 / q7 / q8 / q9 / q10 / q11 / q12. q13 starts at n=122.
CLOSED_BEFORE_Q4 = {
    12,
    15,
    16,
...
def main():
    ...
    rec = {
        ...
        "remaining_after_q12": leftover,
        "n122": cube_range(122, 41),
        "n123": cube_range(123, 41),
        ...
        "note": (
            ...
            "q12 closed 121 leftover. "
            "First leftover for this folder is n=122, d=41."
        ),
    }
