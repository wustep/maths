# Leftover exact holes from n=147

After the q36 pigeonhole certificates through n=146, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=147, δ⁺=49.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=147
(d=49, k=49..96, 48 cubes; k=97 empty by the N⁺ counting cut).
The first remaining hole is n=148, δ⁺=50.
