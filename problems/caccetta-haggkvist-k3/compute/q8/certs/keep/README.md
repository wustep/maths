...
from n=117 onward. q7 stays the n=116 store.

n=117 is stored (38 cubes, k=39..76). First remaining hole n=118.
...
```
cd problems/caccetta-haggkvist-k3/compute/q8
./build_solvers.sh
./run_all.sh
```

The index is `replay.json` after a successful `verify_keep.py`.
Independent range log: `replay_117.json`.
