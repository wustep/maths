...
# Exact orders already stored in q1 / q2 / q3 / q4 / q5 / q6 / q7 / q8. q9 starts at n=118.
CLOSED_BEFORE_Q4 = {
    12,
    15,
    16,
...
def main():
    ...
    rec = {
        ...
        "note": (
            ...
            "q8 closed 117 leftover. First leftover for this folder is n=118, d=40."
        ),
    }
