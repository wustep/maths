# Leftover exact holes from n=145

After the q34 pigeonhole certificates through n=144, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=145, δ⁺=49.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=145
(d=49, k=49..94, 46 cubes; k=95 empty by the N⁺ counting cut).
The first remaining hole is n=146, δ⁺=49.
