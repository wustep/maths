...
# Exact orders already stored in q1 / q2 / q3 / q4 / q5 / q6. q7 starts at n=116.
CLOSED_BEFORE_Q4 = {
    12,
    15,
    16,
...
def main():
    ...
    rec = {
        ...
        "remaining_after_q6": leftover,
        "n116": cube_range(116, 39),
        "n117": cube_range(117, 39),
        "n118": cube_range(118, 40),
        "note": (
            ...
            "q6 closed 115 leftover. First leftover for this folder is n=116, d=39."
        ),
    }
