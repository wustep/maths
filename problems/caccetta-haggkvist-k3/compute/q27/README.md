# Leftover exact holes from n=136

After the q26 pigeonhole certificates through n=135, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=136, δ⁺=46.
...
Those cubes are not yet stored at leftover n=136. After n=72 the
leftover n are consecutive. The first remaining hole is n=136,
δ⁺=46. Incomplete search here is residue, not a bound.
