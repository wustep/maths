# Leftover exact holes from n=120

After the q10 pigeonhole certificates through n=119, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=120, δ⁺=40.
