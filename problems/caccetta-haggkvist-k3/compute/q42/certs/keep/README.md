...
from n=152 onward. q41 stays the n=151 store.

n=152 is stored (49 cubes, k=51..99). First remaining hole n=153.
...
```
cd problems/caccetta-haggkvist-k3/compute/q42
./build_solvers.sh
./run_all.sh
```

The index is `replay.json` after a successful `verify_keep.py`.
Independent range log: `replay_152.json`.
