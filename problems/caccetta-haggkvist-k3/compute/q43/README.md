# Leftover exact holes from n=153

After the pigeonhole certificates through n=152, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=153, δ⁺=51.
...
Those cubes are not stored yet. The first remaining hole is n=153,
δ⁺=51. Needed cubes at that order are k=51..100 (50 cubes; k=101
empty by the N⁺ counting cut). Covering survivors are k=51..74.
