# Leftover exact holes from n=127

After the q17 pigeonhole certificates through n=126, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=127, δ⁺=43.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=127
(40 cubes, k=43..82). After n=72 the leftover n are consecutive.
The first remaining hole is n=128, δ⁺=43.
