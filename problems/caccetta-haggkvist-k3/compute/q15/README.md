# Leftover exact holes from n=124

After the q14 pigeonhole certificates through n=123, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=124, δ⁺=42.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=124
(39 cubes, k=42..80). After n=72 the leftover n are consecutive.
The first remaining hole is n=125, δ⁺=42.
