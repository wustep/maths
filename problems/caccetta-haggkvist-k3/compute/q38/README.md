# Leftover exact holes from n=148

After the q37 pigeonhole certificates through n=147, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=148, δ⁺=50.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=148
(d=50, k=50..96, 47 cubes; k=97 empty by the N⁺ counting cut).
The first remaining hole is n=149, δ⁺=50.
