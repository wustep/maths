# Leftover exact holes from n=150

After the pigeonhole certificates through n=149, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=150, δ⁺=50.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=150
(d=50, k=50..98, 49 cubes; k=99 empty by the N⁺ counting cut).
The first remaining hole is n=151, δ⁺=51.
