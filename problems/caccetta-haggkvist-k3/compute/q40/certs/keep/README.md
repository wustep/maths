...
from n=150 onward. q39 stays the n=149 store.

n=150 is stored (49 cubes, k=50..98). First remaining hole n=151.
...
```
cd problems/caccetta-haggkvist-k3/compute/q40
./build_solvers.sh
./run_all.sh
```

The index is `replay.json` after a successful `verify_keep.py`.
Independent range log: `replay_150.json`.
