# Leftover exact holes from n=130

After the q20 pigeonhole certificates through n=129, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=130, δ⁺=44.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=130
(41 cubes, k=44..84). After n=72 the leftover n are consecutive.
The first remaining hole is n=131, δ⁺=44.
