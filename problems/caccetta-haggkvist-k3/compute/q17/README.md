# Leftover exact holes from n=126

After the q16 pigeonhole certificates through n=125, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=126, δ⁺=42.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=126
(41 cubes, k=42..82). After n=72 the leftover n are consecutive.
The first remaining hole is n=127, δ⁺=43.
