# Leftover exact holes from n=151

After the pigeonhole certificates through n=150, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=151, δ⁺=51.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=151
(d=51, k=51..98, 48 cubes; k=99 empty by the N⁺ counting cut).
The first remaining hole is n=152, δ⁺=51.
