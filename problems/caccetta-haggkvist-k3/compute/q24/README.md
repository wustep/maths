# Leftover exact holes from n=133

After the q23 pigeonhole certificates through n=132, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=133, δ⁺=45.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=133
(42 cubes, k=45..86). After n=72 the leftover n are consecutive.
The first remaining hole is n=134, δ⁺=45.
