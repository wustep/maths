# Leftover exact holes from n=129

After the q19 pigeonhole certificates through n=128, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=129, δ⁺=43.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=129
(42 cubes, k=43..84). After n=72 the leftover n are consecutive.
The first remaining hole is n=130, δ⁺=44.
