# Leftover exact holes from n=146

After the q35 pigeonhole certificates through n=145, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=146, δ⁺=49.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=146
(d=49, k=49..95, 47 cubes; k=96 empty by the N⁺ counting cut).
The first remaining hole is n=147, δ⁺=49.
