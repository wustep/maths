# Leftover exact holes from n=132

After the q22 pigeonhole certificates through n=131, the remaining
exact orders not implied by Hoàng–Reed or by HKN 0.3465 (nor by
the stored F₄ certificate at 0.34640) begin at n=132, δ⁺=44.
...
Those cubes are UNSAT, with stored DRATs, at leftover n=132
(43 cubes, k=44..86). After n=72 the leftover n are consecutive.
The first remaining hole is n=133, δ⁺=45.
