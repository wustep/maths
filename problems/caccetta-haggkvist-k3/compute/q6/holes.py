...
# Exact orders already stored in q1 / q2 / q3 / q4 / q5. q6 starts at n=115.
CLOSED_BEFORE_Q4 = {
    12,
    15,
    16,
...
def main():
    ...
    rec = {
        ...
        "remaining_after_q5": leftover,
        "n115": cube_range(115, 39),
        ...
        "note": (
            ...
            "First leftover for this folder is n=115, d=39."
        ),
    }
