...
## 25. 27 August, leftover holes from n=128

The same cubes keep dying past n=127. A 43-outregular oriented graph on 128 vertices has 5504 arcs, so some in-degree is at least 43. The needed k are 43 through 83; k=84 is empty by the N⁺ counting cut.

n=128 k=43 is the old leftover hole from the n=127 wrap. It is UNSAT. Independent replay of those 41 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=43 core stays about 12 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 41 DRATs in `compute/q19/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=129. The conjecture 1/3 is open.

## 26. 27 August, leftover holes from n=129

The same cubes keep dying past n=128. A 43-outregular oriented graph on 129 vertices has 5547 arcs, so some in-degree is at least 43. The needed k are 43 through 84; k=85 is empty by the N⁺ counting cut.

n=129 k=43 is the old leftover hole from the n=128 wrap. It is UNSAT. Independent replay of those 42 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=44 core stays about 7.4 MB.
...
## 28. 27 August, leftover holes from n=131

The same cubes keep dying past n=130. A 44-outregular oriented graph on 131 vertices has 5764 arcs, so some in-degree is at least 44. The needed k are 44 through 85; k=86 is empty by the N⁺ counting cut.

n=131 k=44 is the old leftover hole from the n=130 wrap. It is UNSAT. Independent replay of those 42 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=46 core stays about 13 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 42 DRATs in `compute/q22/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=132. The conjecture 1/3 is open.

## 29. 27 August, leftover holes from n=132

The same cubes keep dying past n=131. A 44-outregular oriented graph on 132 vertices has 5808 arcs, so some in-degree is at least 44. The needed k are 44 through 86; k=87 is empty by the N⁺ counting cut.

n=132 k=44 is the old leftover hole from the n=131 wrap. It is UNSAT. Independent replay of those 43 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=44 core stays about 12 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 43 DRATs in `compute/q23/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=133. The conjecture 1/3 is open.

## 30. 28 August, leftover holes from n=133

The same cubes keep dying past n=132. A 45-outregular oriented graph on 133 vertices has 5985 arcs, so some in-degree is at least 45. The needed k are 45 through 86; k=87 is empty by the N⁺ counting cut.

n=133 k=45 is the old leftover hole from the n=132 wrap. It is UNSAT. Independent replay of those 42 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=45 core stays about 11 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 42 DRATs in `compute/q24/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=134. The conjecture 1/3 is open.

## 31. 28 August, leftover holes from n=134

The same cubes keep dying past n=133. A 45-outregular oriented graph on 134 vertices has 6030 arcs, so some in-degree is at least 45. The needed k are 45 through 87; k=88 is empty by the N⁺ counting cut.

n=134 k=45 is the old leftover hole from the n=133 wrap. It is UNSAT. Independent replay of those 43 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=46 core stays about 16 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 43 DRATs in `compute/q25/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=135. The conjecture 1/3 is open.

## 32. 28 August, leftover holes from n=135

The same cubes keep dying past n=134. A 45-outregular oriented graph on 135 vertices has 6075 arcs, so some in-degree is at least 45. The needed k are 45 through 88; k=89 is empty by the N⁺ counting cut.

n=135 k=45 is the old leftover hole from the n=134 wrap. It is UNSAT. Independent replay of those 44 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=49 core stays about 17 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 44 DRATs in `compute/q26/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=136. The conjecture 1/3 is open.

## 33. 28 August, leftover holes from n=136

The same cubes keep dying past n=135. A 46-outregular oriented graph on 136 vertices has 6256 arcs, so some in-degree is at least 46. The needed k are 46 through 88; k=89 is empty by the N⁺ counting cut.

n=136 k=46 is the old leftover hole from the n=135 wrap. It is UNSAT. Independent replay of those 43 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=50 core stays about 13 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 43 DRATs in `compute/q27/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=137. The conjecture 1/3 is open.

## 34. 28 August, leftover holes from n=137

The same cubes keep dying past n=136. A 46-outregular oriented graph on 137 vertices has 6302 arcs, so some in-degree is at least 46. The needed k are 46 through 89; k=90 is empty by the N⁺ counting cut.

n=137 k=46 is the old leftover hole from the n=136 wrap. It is UNSAT. Independent replay of those 44 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=46 core stays about 13 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 44 DRATs in `compute/q28/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=138. The conjecture 1/3 is open.

## 35. 28 August, leftover holes from n=138

The same cubes keep dying past n=137. A 46-outregular oriented graph on 138 vertices has 6348 arcs, so some in-degree is at least 46. The needed k are 46 through 90; k=91 is empty by the N⁺ counting cut.

n=138 k=46 is the old leftover hole from the n=137 wrap. It is UNSAT. Independent replay of those 45 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=48 core stays about 16 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 45 DRATs in `compute/q29/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=139. The conjecture 1/3 is open.

## 36. 28 August, leftover holes from n=139

The same cubes keep dying past n=138. A 47-outregular oriented graph on 139 vertices has 6533 arcs, so some in-degree is at least 47. The needed k are 47 through 90; k=91 is empty by the N⁺ counting cut.

n=139 k=47 is the old leftover hole from the n=138 wrap. It is UNSAT. Independent replay of those 44 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=49 core stays about 19 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 44 DRATs in `compute/q30/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=140. The conjecture 1/3 is open.

## 37. 28 August, leftover holes from n=140

The same cubes keep dying past n=139. A 47-outregular oriented graph on 140 vertices has 6580 arcs, so some in-degree is at least 47. The needed k are 47 through 91; k=92 is empty by the N⁺ counting cut.

n=140 k=47 is the old leftover hole from the n=139 wrap. It is UNSAT. Independent replay of those 45 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=50 core stays about 22 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 45 DRATs in `compute/q31/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=141. The conjecture 1/3 is open.

## 38. 28 August, leftover holes from n=141

The same cubes keep dying past n=140. A 47-outregular oriented graph on 141 vertices has 6627 arcs, so some in-degree is at least 47. The needed k are 47 through 92; k=93 is empty by the N⁺ counting cut.

n=141 k=47 is the old leftover hole from the n=140 wrap. It is UNSAT. Independent replay of those 46 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=48 core stays about 19 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 46 DRATs in `compute/q32/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=142. The conjecture 1/3 is open.

## 39. 28 August, leftover holes from n=142

The same cubes keep dying past n=141. A 48-outregular oriented graph on 142 vertices has 6816 arcs, so some in-degree is at least 48. The needed k are 48 through 92; k=93 is empty by the N⁺ counting cut.

n=142 k=48 is the old leftover hole from the n=141 wrap. It is UNSAT. Independent replay of those 45 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=49 core stays about 27 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 45 DRATs in `compute/q33/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=143. The conjecture 1/3 is open.

## 40. 28 August, leftover holes from n=143

The same cubes keep dying past n=142. A 48-outregular oriented graph on 143 vertices has 6864 arcs, so some in-degree is at least 48. The needed k are 48 through 93; k=94 is empty by the N⁺ counting cut.

n=143 k=48 is the old leftover hole from the n=142 wrap. It is UNSAT. Independent replay of those 46 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=54 core stays about 18.5 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 46 DRATs in `compute/q34/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. n=144 is closed in the same folder. The first hole not run is n=145. The conjecture 1/3 is open.

## 41. 28 August, leftover holes from n=144

The same cubes keep dying past n=143. A 48-outregular oriented graph on 144 vertices has 6912 arcs, so some in-degree is at least 48. The needed k are 48 through 94; k=95 is empty by the N⁺ counting cut.

n=144 k=48 is the old leftover hole from the n=143 wrap. It is UNSAT. Independent replay of those 47 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=54 core stays about 24 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 47 DRATs in `compute/q34/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=145. The conjecture 1/3 is open.

## 42. 28 August, leftover holes from n=145

The same cubes keep dying past n=144. A 49-outregular oriented graph on 145 vertices has 7105 arcs, so some in-degree is at least 49. The needed k are 49 through 94; k=95 is empty by the N⁺ counting cut.

n=145 k=49 is the old leftover hole from the n=144 wrap. It is UNSAT. Independent replay of those 46 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=51 core stays about 15 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 46 DRATs in `compute/q35/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=146. The conjecture 1/3 is open.

## 43. 29 August, leftover holes from n=146

The same cubes keep dying past n=145. A 49-outregular oriented graph on 146 vertices has 7154 arcs, so some in-degree is at least 49. The needed k are 49 through 95; k=96 is empty by the N⁺ counting cut.

n=146 k=49 is the old leftover hole from the n=145 wrap. It is UNSAT. Independent replay of those 47 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=50 core stays about 25 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 47 DRATs in `compute/q36/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=147. The conjecture 1/3 is open.

## 44. 29 August, leftover holes from n=147

The same cubes keep dying past n=146. A 49-outregular oriented graph on 147 vertices has 7203 arcs, so some in-degree is at least 49. The needed k are 49 through 96; k=97 is empty by the N⁺ counting cut.

n=147 k=49 is the old leftover hole from the n=146 wrap. It is UNSAT. Independent replay of those 48 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=50 core stays about 17 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 48 DRATs in `compute/q37/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=148. The conjecture 1/3 is open.

## 45. 29 August, leftover holes from n=148

The same cubes keep dying past n=147. A 50-outregular oriented graph on 148 vertices has 7400 arcs, so some in-degree is at least 50. The needed k are 50 through 96; k=97 is empty by the N⁺ counting cut.

n=148 k=50 is the old leftover hole from the n=147 wrap. It is UNSAT. Independent replay of those 47 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=52 core stays about 28 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 47 DRATs in `compute/q38/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=149. The conjecture 1/3 is open.

## 46. 29 August, leftover holes from n=149

The same cubes keep dying past n=148. A 50-outregular oriented graph on 149 vertices has 7450 arcs, so some in-degree is at least 50. The needed k are 50 through 97; k=98 is empty by the N⁺ counting cut.

n=149 k=50 is the old leftover hole from the n=148 wrap. It is UNSAT. Independent replay of those 48 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=51 core stays about 28 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 48 DRATs in `compute/q39/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=150. The conjecture 1/3 is open.

## 47. 29 August, leftover holes from n=150

The same cubes keep dying past n=149. A 50-outregular oriented graph on 150 vertices has 7500 arcs, so some in-degree is at least 50. The needed k are 50 through 98; k=99 is empty by the N⁺ counting cut.

n=150 k=50 is the old leftover hole from the n=149 wrap. It is UNSAT. Independent replay of those 49 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=52 core stays about 38 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 49 DRATs in `compute/q40/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=151. The conjecture 1/3 is open.

## 48. 29 August, leftover holes from n=151

The same cubes keep dying past n=150. A 51-outregular oriented graph on 151 vertices has 7701 arcs, so some in-degree is at least 51. The needed k are 51 through 98; k=99 is empty by the N⁺ counting cut.

n=151 k=51 is the old leftover hole from the n=150 wrap. It is UNSAT. Independent replay of those 48 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=52 core stays about 35 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 48 DRATs in `compute/q41/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=152. The conjecture 1/3 is open.

## 49. 29 August, leftover holes from n=152

The same cubes keep dying past n=151. A 51-outregular oriented graph on 152 vertices has 7752 arcs, so some in-degree is at least 51. The needed k are 51 through 99; k=100 is empty by the N⁺ counting cut.

n=152 k=51 is the old leftover hole from the n=151 wrap. It is UNSAT. Independent replay of those 49 cubes is 0 failures. Raw kissat proofs again grow past 100 MB; `drat-trim` core lemmas still replay. The k=51 core stays about 31 MB.

A numerical try that did not move: F₄ stays 0.34640 at the stored CKLS-fork ray.

The stored proofs for this order are the 49 DRATs in `compute/q42/certs/keep/`. Replay regenerates each CNF and runs `drat-trim`. The first hole not run is n=153. The conjecture 1/3 is open.
