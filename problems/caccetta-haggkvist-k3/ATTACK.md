...
Leftover n=135 is closed: d=45, cubes k=45..88, 44 stored DRATs after `drat-trim -l` (k=49 is 17.1 MB). Independent replay: `python3 verify_range.py --n-min 135 --n-max 135` reports 44 checked, 0 failures.

Dent against that finite leftover hole. n=136 is not stored. Residue, not a bound.

F₄ stays 0.34640. The stored CKLS-fork ray still replays. Did not overwrite `q4/certs/keep/f4_or_new_certificate.json`. Did not beat 0.3388.

First remaining hole n=136, δ⁺=46. Conjecture 1/3 open.

### 2026-08-28 — leftover cubes from n=136

Same encoder as q1–q26. New proofs live in `compute/q27/certs/keep/` (q26 stays the n=135 store).

Leftover n=136 is closed: d=46, cubes k=46..88, 43 stored DRATs after `drat-trim -l` (k=50 is 13.0 MB). Independent replay: `python3 verify_range.py --n-min 136 --n-max 136` reports 43 checked, 0 failures.

Dent against that finite leftover hole. n=137 is not stored. Residue, not a bound.

F₄ stays 0.34640. The stored CKLS-fork ray still replays. Did not overwrite `q4/certs/keep/f4_or_new_certificate.json`. Did not beat 0.3388.

First remaining hole n=137, δ⁺=46. Conjecture 1/3 open.

### 2026-08-28 — leftover cubes from n=137

Same encoder as q1–q27. New proofs live in `compute/q28/certs/keep/` (q27 stays the n=136 store).

Leftover n=137 is closed: d=46, cubes k=46..89, 44 stored DRATs after `drat-trim -l` (k=46 is 13.0 MB). Independent replay: `python3 verify_range.py --n-min 137 --n-max 137` reports 44 checked, 0 failures.

Dent against that finite leftover hole. n=138 is not stored. Residue, not a bound.

F₄ stays 0.34640. The stored CKLS-fork ray still replays. Did not overwrite `q4/certs/keep/f4_or_new_certificate.json`. Did not beat 0.3388.

First remaining hole n=138, δ⁺=46. Conjecture 1/3 open.

### 2026-08-28 — leftover cubes from n=138

Same encoder as q1–q28. New proofs live in `compute/q29/certs/keep/` (q28 stays the n=137 store).

Leftover n=138 is closed: d=46, cubes k=46..90, 45 stored DRATs after `drat-trim -l` (k=48 is 16.4 MB). Independent replay: `python3 verify_range.py --n-min 138 --n-max 138` reports 45 checked, 0 failures.

Dent against that finite leftover hole. n=139 is not stored. Residue, not a bound.
...
Leftover n=139 is closed: d=47, cubes k=47..90, 44 stored DRATs after `drat-trim -l` (k=49 is 18.5 MB). Independent replay: `python3 verify_range.py --n-min 139 --n-max 139` reports 44 checked, 0 failures.

Dent against that finite leftover hole. n=140 is not stored. Residue, not a bound.

F₄ stays 0.34640. The stored CKLS-fork ray still replays. Did not overwrite `q4/certs/keep/f4_or_new_certificate.json`. Did not beat 0.3388.

First remaining hole n=140, δ⁺=47. Conjecture 1/3 open.

### 2026-08-28 — leftover cubes from n=140

Same encoder as q1–q30. New proofs live in `compute/q31/certs/keep/` (q30 stays the n=139 store).

Leftover n=140 is closed: d=47, cubes k=47..91, 45 stored DRATs after `drat-trim -l` (k=50 is 22 MB). Independent replay: `python3 verify_range.py --n-min 140 --n-max 140` reports 45 checked, 0 failures.

Dent against that finite leftover hole. n=141 is not stored. Residue, not a bound.

F₄ stays 0.34640. The stored CKLS-fork ray still replays. Did not overwrite `q4/certs/keep/f4_or_new_certificate.json`. Did not beat 0.3388.

First remaining hole n=141, δ⁺=47. Conjecture 1/3 open.

### 2026-08-28 — leftover cubes from n=141

Same encoder as q1–q31. New proofs live in `compute/q32/certs/keep/` (q31 stays the n=140 store).

Leftover n=141 is closed: d=47, cubes k=47..92, 46 stored DRATs after `drat-trim -l` (k=48 is 19 MB). Independent replay: `python3 verify_range.py --n-min 141 --n-max 141` reports 46 checked, 0 failures.

Dent against that finite leftover hole. n=142 is not stored. Residue, not a bound.
...
### 2026-08-28 — leftover cubes from n=143

Same encoder as q1–q33. New proofs live in `compute/q34/certs/keep/` (q33 stays the n=142 store).

Leftover n=143 is closed: d=48, cubes k=48..93, 46 stored DRATs after `drat-trim -l` (k=54 is 18.5 MB). Independent replay: `python3 verify_range.py --n-min 143 --n-max 143` reports 46 checked, 0 failures.

Dent against that finite leftover hole. n=144 is closed in the same folder (next paragraph). n=145 is not stored. Residue, not a bound.

F₄ stays 0.34640. The stored CKLS-fork ray still replays. Did not overwrite `q4/certs/keep/f4_or_new_certificate.json`. Did not beat 0.3388.

### 2026-08-28 — leftover cubes from n=144

Same encoder as q1–q33. Proofs for this order also live in `compute/q34/certs/keep/`.

Leftover n=144 is closed: d=48, cubes k=48..94, 47 stored DRATs after `drat-trim -l` (k=54 is 23.9 MB). Independent replay: `python3 verify_range.py --n-min 144 --n-max 144` reports 47 checked, 0 failures.

Dent against that finite leftover hole. n=145 is not stored. Residue, not a bound.

F₄ stays 0.34640. The stored CKLS-fork ray still replays. Did not overwrite `q4/certs/keep/f4_or_new_certificate.json`. Did not beat 0.3388.

First remaining hole n=145, δ⁺=49. Conjecture 1/3 open.

### 2026-08-28 — leftover cubes from n=145

Same encoder as q1–q34. New proofs live in `compute/q35/certs/keep/` (q34 stays the n=143–144 store).

Leftover n=145 is closed: d=49, cubes k=49..94, 46 stored DRATs after `drat-trim -l` (k=51 is 15.0 MB). Independent replay: `python3 verify_range.py --n-min 145 --n-max 145` reports 46 checked, 0 failures.

Dent against that finite leftover hole. n=146 is not stored. Residue, not a bound.

F₄ stays 0.34640. The stored CKLS-fork ray still replays. Did not overwrite `q4/certs/keep/f4_or_new_certificate.json`. Did not beat 0.3388.

First remaining hole n=146, δ⁺=49. Conjecture 1/3 open.

### 2026-08-29 — leftover cubes from n=146

Same encoder as q1–q35. New proofs live in `compute/q36/certs/keep/` (q35 stays the n=145 store).

Leftover n=146 is closed: d=49, cubes k=49..95, 47 stored DRATs after `drat-trim -l` (k=50 is 24.2 MB). Independent replay: `python3 verify_range.py --n-min 146 --n-max 146` reports 47 checked, 0 failures.

Dent against that finite leftover hole. n=147 is not stored. Residue, not a bound.

F₄ stays 0.34640. The stored CKLS-fork ray still replays. Did not overwrite `q4/certs/keep/f4_or_new_certificate.json`. Did not beat 0.3388.

First remaining hole n=147, δ⁺=49. Conjecture 1/3 open.

### 2026-08-29 — leftover cubes from n=147

Same encoder as q1–q36. New proofs live in `compute/q37/certs/keep/` (q36 stays the n=146 store).

Leftover n=147 is closed: d=49, cubes k=49..96, 48 stored DRATs after `drat-trim -l` (k=50 is 16.9 MB). Independent replay: `python3 verify_range.py --n-min 147 --n-max 147` reports 48 checked, 0 failures.

Dent against that finite leftover hole. n=148 is not stored. Residue, not a bound.

F₄ stays 0.34640. The stored CKLS-fork ray still replays. Did not overwrite `q4/certs/keep/f4_or_new_certificate.json`. Did not beat 0.3388.

First remaining hole n=148, δ⁺=50. Conjecture 1/3 open.

### 2026-08-29 — leftover cubes from n=148

Same encoder as q1–q37. New proofs live in `compute/q38/certs/keep/` (q37 stays the n=147 store).

Leftover n=148 is closed: d=50, cubes k=50..96, 47 stored DRATs after `drat-trim -l` (k=52 is 27.6 MB). Independent replay: `python3 verify_range.py --n-min 148 --n-max 148` reports 47 checked, 0 failures.

Dent against that finite leftover hole. n=149 is not stored. Residue, not a bound.
...
### 2026-08-29 — leftover cubes from n=150 (q40 start)

Same encoder as q1–q39. New proofs will live in `compute/q40/certs/keep/` (q39 stays the n=149 store).

Independent cube bounds at leftover n=150: ⌈150/3⌉=50, so d=50. HKN 0.3465·150=51.975 and the stored F₄ 0.34640·150=51.96 both sit above 50, so the order is leftover. Even the 0.3388 personal communication still has 0.3388·150=50.82>50. A 50-outregular graph on 150 vertices has 7500 arcs, so some in-degree is at least 50. Each v∈N⁺(0) needs 50 outs from (N⁺(0)\{v})∪U, size 148−k, hence k≤98. Absolute max k=99 is empty by that N⁺ cut. Needed cubes: k=50..98 (49). The 2-cycle covering count on A empties k≥74 (σ=n−2−d−k=98−k; survive when σ≥⌊(d−1)/2⌋+1=25, i.e. k≤73). SAT work is k=50..73. That is the same arithmetic as n=149, recomputed here, not copied as a prescription.

F₄ stays 0.34640. Did not beat 0.3388. n=150 not stored yet. Residue until the 49 DRATs exist and an independent `verify_range` reports 0 failures. Stored leftover SAT is residue, not a bound. A dent is only a verified move of F₄ below 0.3388, or a new exact-CH theorem.

### 2026-08-29 — leftover cubes from n=150

Same encoder as q1–q39. New proofs live in `compute/q40/certs/keep/` (q39 stays the n=149 store).

Leftover n=150 is closed: d=50, cubes k=50..98, 49 stored DRATs after `drat-trim -l` (k=52 is 37.9 MB). Independent replay: `python3 verify_range.py --n-min 150 --n-max 150` reports 49 checked, 0 failures.

Stored leftover SAT is residue, not a bound. n=151 is not stored. A dent is only a verified move of F₄ below 0.3388, or a new exact-CH theorem.
...
### 2026-08-29 — leftover cubes from n=152 (q42 start)

Same encoder as q1–q41. New proofs will live in `compute/q42/certs/keep/` (q41 stays the n=151 store).

Independent cube bounds at leftover n=152: ⌈152/3⌉=51, so d=51. HKN 0.3465·152=52.668 and the stored F₄ 0.34640·152=52.6528 both sit above 51, so the order is leftover. Even the 0.3388 personal communication still has 0.3388·152=51.4976>51. A 51-outregular graph on 152 vertices has 7752 arcs, so some in-degree is at least 51. Each v∈N⁺(0) needs 51 outs from (N⁺(0)\{v})∪U, size 150−k, hence k≤99. Absolute max k=100 is empty by that N⁺ cut. Needed cubes: k=51..99 (49). The 2-cycle covering count on A empties k≥74 (σ=n−2−d−k=99−k; survive when σ≥⌊(d−1)/2⌋+1=26, i.e. k≤73). SAT work is k=51..73. That arithmetic is recomputed here, not copied as a prescription.
