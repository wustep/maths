...
- Replayed $m(53)=14$: the saved 14-set passes the definition directly, while the Rust search returned `UNSAT` for every set of size at most 13 after 333,555,078 nodes in 1,701.630 seconds. This matches the published term; it does not improve it.
