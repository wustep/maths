...
- Problem: `problems/no-unique-sum-mod-p`
- Quest: `q1-overnight`
...
- `quests/q1-overnight.md` — the quest-level outcome and residue.

From the repository root, the decisive replay command is:

```bash
.venv/bin/python problems/no-unique-sum-mod-p/compute/verify_m_p.py
```
