...
PRIMES = (2, 3, 5)
DEG = (18, 24)
# q4 independently replayed these three; do not re-solve them here.
...
def main() -> int:
    ...
    rec = {
        ...
        "note": (
            ...
            "(k=3). leftover_q5 skips those three. This list is not a "
            "bound on R(5,5)."
        ),
        "primes": list(PRIMES),
        "q4_closed": sorted(Q4_CLOSED),
        "q5_names": [row["name"] for row in leftover_q5()],
        "q5_total": len(leftover_q5()),
    ...
    print(json.dumps({
        ...
        "q5_total": rec["q5_total"],
        "total": rec["total"],
        "totals_by_prime": rec["totals_by_prime"],
        "q5_names": rec["q5_names"],
