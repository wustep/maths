...
def main() -> int:
    ...
    rec = {
        ...
        "note": (
            ...
            "5^5 1^18 at k=2 (covers k=3). q7 stored no new certificate. "
            "leftover_q8 skips those five. This list is not a bound on "
            "R(5,5)."
        ),
        "primes": list(PRIMES),
        ...
        "q8_names": [row["name"] for row in leftover_q8()],
        "q8_total": len(leftover_q8()),
    ...
    print(json.dumps({
        ...
        "q8_total": rec["q8_total"],
        "total": rec["total"],
        "totals_by_prime": rec["totals_by_prime"],
        "q8_names": rec["q8_names"],
