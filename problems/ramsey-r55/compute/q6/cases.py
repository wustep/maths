...
def main() -> int:
    ...
    rec = {
        ...
        "note": (
            ...
            "(k=3). q5 closed 5^4 1^23 at k=4 (covers k=0). leftover_q6 "
            "skips those four. This list is not a bound on R(5,5)."
        ),
        "primes": list(PRIMES),
        "q4_closed": sorted(Q4_CLOSED),
        "q5_closed": sorted(Q5_CLOSED),
        "q6_names": [row["name"] for row in leftover_q6()],
        "q6_total": len(leftover_q6()),
    ...
    print(json.dumps({
        ...
        "q6_total": rec["q6_total"],
        "total": rec["total"],
        "totals_by_prime": rec["totals_by_prime"],
        "q6_names": rec["q6_names"],
