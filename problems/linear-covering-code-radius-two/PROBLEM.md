...
- [q1-overnight](quests/q1-overnight.md) — beat a documented small \(\ell_2(r,2)\). Status: dent \(\ell_2(10,2)\le 50\).
- [q2-second-pass](quests/q2-second-pass.md) — push 50 to 49 using `H_r10_n50.txt` as seed. Status: residue (7 uncovered on \(n=49\)).
