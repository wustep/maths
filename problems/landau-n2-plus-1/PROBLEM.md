...
- Status: open; dent: certified $n\le 10^7$ matching Wolf $\pi_q(10^{14})$
...
Done for N=10^7: 456362 primes (matches Wolf π_q(10^14)), 1334083 Ω=2
composites, Bateman–Horn ratio 0.99990. Extends the N=10^6 prefix
(54110 primes, Wolf π_q(10^12)). No new prime off Wolf/Grantham.
