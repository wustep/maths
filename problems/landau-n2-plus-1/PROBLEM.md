...
- Status: open; dent: certified $n\le 10^8$ matching Wolf $\pi_q(10^{16})$
...
Done for N=10^8: 3954181 primes (matches Wolf π_q(10^16)), 12172983 Ω=2
composites, Bateman–Horn ratio 0.99972. Extends the N=10^7 prefix
(456362 primes, Wolf π_q(10^14)). No new prime off Wolf/Grantham.
