...
## Dent (2026-09-12, leftover one-flip balls)

**Number of nonempty degree-eight T-curve schemes ≥ 2,394.** This is
exactly the inequality in [`compute/q9/CLAIM.md`](compute/q9/CLAIM.md).
Nine schemes lie outside both the 2,367 of Geiselmann et al.,
arXiv:2602.06888v4, §4.3, the seventeen prior additions, and the q8
scheme ⟨3 ⊔ 1⟨3⟩ ⊔ 1⟨12⟩⟩:

⟨3 ⊔ 1⟨5⟩ ⊔ 1⟨10⟩⟩, ⟨5 ⊔ 1⟨2⟩ ⊔ 1⟨3⟩ ⊔ 1⟨7⟩⟩,
⟨5 ⊔ 1⟨1⟩ ⊔ 1⟨2⟩ ⊔ 1⟨9⟩⟩, ⟨4 ⊔ 1⟨1⟩ ⊔ 1⟨2⟩ ⊔ 1⟨9⟩⟩,
⟨3 ⊔ 1⟨1⟩ ⊔ 1⟨2⟩ ⊔ 1⟨9⟩⟩, ⟨2 ⊔ 1⟨1⟩ ⊔ 1⟨2⟩ ⊔ 1⟨9⟩⟩,
⟨4 ⊔ 1⟨1⟩ ⊔ 1⟨3⟩ ⊔ 1⟨9⟩⟩, ⟨3 ⊔ 1⟨1⟩ ⊔ 1⟨3⟩ ⊔ 1⟨9⟩⟩,
⟨2 ⊔ 1⟨1⟩ ⊔ 1⟨3⟩ ⊔ 1⟨9⟩⟩.

Each witness changes one diagonal of a published or previously
certified mesh, then at most three signs. Integer liftings pass all
2,688 global strict inequalities. Python traces curve segments; Rust
reconstructs connected monochromatic regions. Both recover the
claimed nesting tree, and each scheme is absent from the archive and
from the previous 2,385.

The leftover 1,108 balls of the q8 plan all finished (16,870,408
evaluations) and produced five of the nine. One-flip balls of those
five certificates produced the other four. One-flip balls of the q8
certificate itself added nothing further. Neither preferred 22-oval
deep nest is decided. Hilbert 16(a) in degree eight remains open.
