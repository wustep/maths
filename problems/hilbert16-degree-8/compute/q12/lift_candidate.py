...
def load_row(task, certs=None):
    if certs:
        rows, seedlist = cert_plan(certs, source_prefix='q12 addition: '), cert_seeds(certs, source_prefix='q12 addition: ')
    else:
...
def main():
    ...
    if args.shard:
        ...
        want = 'q12-certificate-flips' if args.certs else 'q11-followup-leftover'
