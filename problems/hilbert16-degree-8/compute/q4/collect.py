#!/usr/bin/env python3
"""Aggregate every q4 search log into certs/q4_summary.json.
...
def main():
    ...
    summary = {
        "search": "q4: leftover (19,3) nests — three-split ladder, "
                  "pinned even BFS, odd collections of size 5",
        "even_walk": {
            "summaries": even_summ,
    ...
    out = os.path.join(HERE, "certs", "q4_summary.json")
