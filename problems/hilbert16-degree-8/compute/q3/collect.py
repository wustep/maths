#!/usr/bin/env python3
"""Aggregate every q3 search log into certs/q3_summary.json.
...
def main():
    ...
    summary = {
        "search": "q3: radius-1 thicken of leftover census triangulations "
                  "of twist-rank 22-26, three-split ladder on published "
                  "depth-3 M-collections, and the next (19,3) moves",
        "thicken": {
    ...
    out = os.path.join(HERE, "certs", "q3_summary.json")
