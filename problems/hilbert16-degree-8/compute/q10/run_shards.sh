#!/bin/sh
# Two light workers on the 106 leftover one-flip balls.
...
python3 search.py --start 0 --stop 53 --output work/shard0.json \
  >work/shard0.log 2>&1 & echo $! >work/shard0.pid
python3 search.py --start 53 --stop 106 --output work/shard1.json \
