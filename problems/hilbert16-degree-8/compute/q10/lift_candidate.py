...
def load_row(task, certs=None):
    if certs:
        rows, seedlist = cert_plan(certs, source_prefix='q10 addition: '), cert_seeds(certs, source_prefix='q10 addition: ')
    else:
...
def main():
    ...
    if args.shard:
        ...
        want = 'q10-certificate-flips' if args.certs else 'q9-followup-leftover'
