...
28 or more $D_5$-type points. The $n_1\le 27$ slice is unfinished.

The 36-clique in the 355-point $T^5$ remainder: no 35-colouring;
Cadical and Glucose return no model (no stored DRAT). Share 30, 29
and 28 with each published 35 are empty.
