# Cursor Grok 2026-08-27 — Caccetta leftover holes from n=129

Continuation of the Caccetta–Häggkvist directed-triangle campaign.
New leftover SAT lives in `problems/caccetta-haggkvist-k3/compute/q20/`.
q19 stays the n=128 store. q4 stays the n=73–108 store and the
F₄ certificate.

Published unrestricted threshold is still HKN 0.3465
(arXiv:0908.2791v4, Theorem 1.2). Do not treat 0.3388 as published.

Exact leftover hole n=129 is closed (42 stored pigeonhole DRATs).
First remaining hole n=130. F₄ unchanged at c=0.34640. Did not beat
...
cd ../q20
./build_solvers.sh
python3 verify_range.py --n-min 129 --n-max 129
```
