# Cursor Grok 2026-08-27 — Caccetta leftover holes from n=120

Continuation of the Caccetta–Häggkvist directed-triangle campaign.
New leftover SAT lives in `problems/caccetta-haggkvist-k3/compute/q11/`.
q10 stays the n=119 store. q4 stays the n=73–108 store and the
F₄ certificate.

Published unrestricted threshold is still HKN 0.3465
(arXiv:0908.2791v4, Theorem 1.2). Do not treat 0.3388 as published.

Exact leftover hole n=120 is closed (39 stored pigeonhole DRATs).
First remaining hole n=121. F₄ unchanged at c=0.34640. Did not beat
...
cd ../q11
./build_solvers.sh
python3 verify_range.py --n-min 120 --n-max 120
```
