# Cursor Grok 2026-08-27 — Caccetta leftover holes from n=109

Continuation of the Caccetta–Häggkvist directed-triangle campaign.
New leftover SAT lives in `problems/caccetta-haggkvist-k3/compute/q5/`.
q4 stays the n=73–108 store and the F₄ certificate.

Published unrestricted threshold is still HKN 0.3465
(arXiv:0908.2791v4, Theorem 1.2). Do not treat 0.3388 as published.

Exact leftover holes n=109 through n=112 are closed (140 stored
pigeonhole DRATs). First remaining hole n=113. F₄ unchanged at
...
cd ../q5
./build_solvers.sh
python3 verify_range.py --n-min 109 --n-max 112
```
