...
| --- | --- | --- | --- | --- |
| covering / ℓ₂(10,2) | `problems/covering` | Codex `gpt-5.6-sol` Max | solver | 2026-08-16 q1+q2 |
...
| Shannon C₇ 5th power | `problems/c7-shannon` | Cursor Grok 4.6 | solver | 2026-08-16 afternoon |
