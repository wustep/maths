...
| [simon-ionization-excess](problems/simon-ionization-excess) | Simon 2000 #9. Replayed Lieb $2Z+1$, Nam $1.22$, and Hundertmark–Pattakos–Schulz. Remainders $2.953$, $3.892$, $3.9781$ from the $Z\ge 4$ ratio. Using the HPS chain, the leading coefficient is now $1.1002$, improving the prior printed $1.1006$, by using the finite kernel range in the aspect-10 mid-radius reweighting step; the completed 37-bin certificate is reused. Hydrogen N0(1)=2 replayed. Bounded excess open. |
...
| Simon ionization excess | `problems/simon-ionization-excess` | GPT-5.6 Sol / wustep | 2026-09-03 |
