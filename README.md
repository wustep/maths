...
| [simon-ionization-excess](problems/simon-ionization-excess) | Simon 2000 #9. Replayed Lieb $2Z+1$, Nam $1.22$, and HPS. Remainders $2.953$, $3.892$, $3.9781$ from the $Z\ge 4$ ratio. Leading coefficient moved from printed $1.1185$ to $1.1118$ by lifting the aspect-12 compact bound through mass-stationarity. Hydrogen N0(1)=2 replayed. Bounded excess open. |
