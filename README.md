...
| [hadwiger-nelson-plane](problems/hadwiger-nelson-plane) | Published interval $5\le\chi(\mathbb R^2)\le7$. Exact Parts spawns on 933, 1,186, and 1,357 vertices are five-colorable; stored models cover add-only subsets of a named 677-point reserve and two rotated copies. No new lower bound. |
