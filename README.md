...
| [caccetta-haggkvist-k3](problems/caccetta-haggkvist-k3) | Exact CH-triangle at n=18, 21, 24, 26, 27, 29, 30, 32, 33, 35, 36 and every leftover order through n=113 (534 stored DRATs through n=72, 1026 through n=108, then 176 more through n=113). First remaining hole n=114. $$F_4\text{ certificate }c=0.34640\text{ (CKLS 2015 fork), below HKN }0.3465\text{ and the prior stored }0.34645.$$ Did not beat 0.3388. Conjecture 1/3 open. |
...
| [simon-ionization-excess](problems/simon-ionization-excess) | Simon 2000 #9. Replayed Lieb $2Z+1$, Nam $1.22$, and Hundertmark–Pattakos–Schulz. Remainders $2.953$, $3.892$, $3.9781$ from the $Z\ge 4$ ratio. Leading coefficient moved from printed $1.1185$ through $1.1118$ and $1.1057$ to $1.1035$ by tightening the compact mid-radius bound and lifting it at aspect 10. Hydrogen N0(1)=2 replayed. Bounded excess open. |
...
| Caccetta–Häggkvist leftover holes through n=113 | `problems/caccetta-haggkvist-k3/compute/q5` | Cursor Grok 4.6 | 2026-08-27 |
