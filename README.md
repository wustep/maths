...
| [hilbert16-degree-8](problems/hilbert16-degree-8) | **Dent.** Sixteen real schemes are realized by certified T-curves and are missing from the 2,367 degree-8 schemes of arXiv:2602.06888v3 (their $\S$5.3 lower bound), so $\ge 2{,}383$. All 2,367 published certificates replayed. Haas zone decompositions implemented and checked against all 38 published M-certificates. Every triangulation of the census is now swept exhaustively — 230.5 million sign distributions — and realizes exactly their 38 M-schemes and no others; 4,074 further certified triangulations outside the census add none. Hilbert 16(a) degree 8 open. |
