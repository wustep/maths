...
The same seed, via $\mathrm{QM}_3^2$ and $\mathrm{QM}_5^2$
(arXiv:2511.02542 Thm 5.1), gives independently replayed lengths
$\ell_2(22,2)\le 3325$, $\ell_2(24,2)\le 6653$,
$\ell_2(26,2)\le 13070$, $\ell_2(28,2)\le 26111$ (paper 3389, 6781,
...
| --- | --- | --- | --- |
| covering / $\ell_2(10,2)$ | `problems/covering` | Codex Sol, Claude Opus, Claude Fable, Grok | 2026-08-16–21 |
| Brocard–Ramanujan | `problems/brocard` | Codex Sol | 2026-08-16 |
| unique-sum mod p | `problems/unique-sum` | Codex Sol | 2026-08-16 |
| no-three-in-line n=71 | `problems/three-in-line` | Codex Sol | 2026-08-16 |
| Schur S(7) | `problems/schur` | Codex Sol | 2026-08-16 |
| van der Waerden W(2,7) | `problems/vdw-w27` | Cursor Grok | 2026-08-16 |
| Shannon $C_7$ 5th power | `problems/c7-shannon` | Cursor Grok | 2026-08-16 |
| Landau 4 ($n^2+1$ primes) | `problems/landau-n2-plus-1` | SuperGrok | 2026-08-17 |
| unit-distance 509 | `problems/unit-distance-509` | SuperGrok | 2026-08-17 |
| Sidon second term | `problems/sidon-second-term` | SuperGrok | 2026-08-17 |
| Chowla cosine | `problems/chowla-cosine` | SuperGrok | 2026-08-17 |
| two-squares gap | `problems/two-squares-gap` | SuperGrok | 2026-08-17 |
| cosine zeros | `problems/cosine-zeros` | SuperGrok | 2026-08-17 |
| Ulam sequence | `problems/ulam-sequence` | SuperGrok | 2026-08-17 |
| long-gap dilate | `problems/long-gap-dilate` | SuperGrok | 2026-08-17 |
| thin cyclic bases | `problems/thin-cyclic-bases` | SuperGrok | 2026-08-17 |
| union-closed | `problems/union-closed` | SuperGrok | 2026-08-17 |
| 0/1 polynomials | `problems/zero-one-polynomials` | SuperGrok | 2026-08-17 |
| Cohn–Elkies planar | `problems/cohn-elkies` | SuperGrok | 2026-08-17 |
| kissing number 5d | `problems/kissing-5d` | SuperGrok | 2026-08-17 |
| affine {0,1,3} copies | `problems/affine-013` | SuperGrok | 2026-08-17 |
| 1/3–2/3 posets | `problems/one-third-two-thirds` | SuperGrok | 2026-08-17 |
| Seymour second neighborhood | `problems/seymour-second-neighborhood` | SuperGrok | 2026-08-17 |
| two smooth summands | `problems/two-smooth-summands` | SuperGrok | 2026-08-17 |
| Tuza triangles | `problems/tuza-triangle-packing-covering` | SuperGrok | 2026-08-17 |
| Caccetta–Häggkvist | `problems/caccetta-haggkvist-k3` | SuperGrok | 2026-08-17 |
| projective plane 12 | `problems/projective-plane-order-twelve` | SuperGrok | 2026-08-17 |
