...
| [caccetta-haggkvist-k3](problems/caccetta-haggkvist-k3) | Exact CH-triangle at every leftover order through n=72 by an in-degree pigeonhole with stored DRAT proofs. $$F_4\text{ certificate still }c=0.34645,\ 5\cdot 10^{-5}\text{ below HKN }0.3465.$$ Numerical threshold unchanged. Conjecture 1/3 open. |
