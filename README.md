...
| [hilbert16-limit-cycles](problems/hilbert16-limit-cycles) | Hilbert 16(b): the Hilbert number H(n), maximum isolated periodic orbits of a planar polynomial vector field of degree n. Published lower bounds still stand: H(2) at least 4 (Shi; Chen–Wang), H(3) at least 13 (Li–Liu–Yang), H(4) at least 28 (Prohens–Torregrosa), and the Han–Li / Chebyshev lifts. No published H(n) moved. Different problem from the degree-8 folder above. |
