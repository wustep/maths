...
| [simon-ionization-excess](problems/simon-ionization-excess) | Simon 2000 #9. Replayed Lieb $2Z+1$, Nam $1.22$, and Hundertmark–Pattakos–Schulz. Remainders $2.953$, $3.892$, $3.9781$ from the $Z\ge 4$ ratio. Leading coefficient moved from printed $1.1185$ through $1.1118$ to $1.1057$ by tightening the compact mid-radius bound and lifting it at aspect 10. Hydrogen N0(1)=2 replayed. Bounded excess open. |
