...
| [caccetta-haggkvist-k3](problems/caccetta-haggkvist-k3) | Exact CH-triangle at n=18, 21, 24, 26, 27, 29, 30, 32, 33, 35, 36 and every leftover order through n=125 (534 stored DRATs through n=72, 1026 through n=108, 213 through n=114, 36 through n=115, 37 through n=116, 38 through n=117, 37 through n=118, 38 through n=119, 39 through n=120, 38 through n=121, 39 through n=122, 40 through n=123, 39 through n=124, then 40 through n=125). First remaining hole n=126. $$F_4\text{ certificate }c=0.34640\text{ (CKLS 2015 fork), below HKN }0.3465\text{ and the prior stored }0.34645.$$ Did not beat 0.3388. Conjecture 1/3 open. |
