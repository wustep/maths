...
| [unique-sum](problems/unique-sum) | Independently replayed through $p=59$, matching OEIS A398173 at that prime (the OEIS table continues through 73). A checked 15-set and a completed exclusion of every smaller size give $m(59)=15$. No published bound improved. |
