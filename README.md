...
| [hilbert16-degree-8](problems/hilbert16-degree-8) | **Number of nonempty degree-eight T-curve schemes ≥ 2,385.** The new scheme ⟨3 ⊔ 1⟨3⟩ ⊔ 1⟨12⟩⟩ is outside the 2,384 baseline formed by the 2,367 certificates of arXiv:2602.06888v4 and the notebook’s seventeen prior additions. Exact integer lifting and independent Python/Rust topology checks pass; [claim and certificate](problems/hilbert16-degree-8/compute/q8/CLAIM.md). Neither open maximal deep nest is decided. Hilbert 16(a) degree 8 remains open. |
