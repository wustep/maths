...
Merging two inherited blocks instead gives a 33-block partition and permits
$m=5$. The resulting bound is

$$
\ell_2(41,3)\le 26175
$$

against Table 7.2's 26238 and the notebook's previous 26206. The certificate
exhausts the $2^{26}$ seed syndromes and checks all 26,175 lift columns.
...
so $\mathrm{QM}_5^3$ gave the earlier theorem-only bounds

$$
\ell_2(38,3)\le 13102,\ \ell_2(41,3)\le 26206
$$

(paper 13118, 26238; not enumerated). The redundancy-41 value is superseded
by 26175 above. Replay:
...
`problems/covering/compute/q13/run_all.sh`, the shorter redundancy-41
construction with `problems/covering/compute/q16/run_all.sh`, and the
redundancy-47 construction with `problems/covering/compute/q15/run_all.sh`.
...
| [covering](problems/covering) | $$\ell_2(10,2)\le 50,\ \ell_2(18,3)\le 151,\ \ell_2(21,3)\le 303,\ \ell_2(26,2)\le 13070,\ \ell_2(26,3)\le 817,\ \ell_2(31,4)\le 689,\ \ell_2(36,2)\le 418271,\ \ell_2(38,3)\le 13102,\ \ell_2(41,3)\le 26175,\ \ell_2(44,3)\le52351,\ \ell_2(47,3)\le104703$$; $\mathrm{QM}\ 22/24/28$ and $$p(H_{18})\le 17,\ p(H_{20})\le 14,\ p(H_{26})\le 19,\ p(H_{28})\le 28$$. The redundancy-44 radius-3 construction improves Table 7.2's 52415 by 64, with an exhaustive $2^{26}$ seed-partition check and a columnwise lift identity. A 33-block merge of the same seed gives the redundancy-41 radius-3 bound 26175, improving Table 7.2's 26238 by 63, with the same seed-sweep and lift-identity checks. A 129-block refinement of the same seed (q15) gives the redundancy-47 bound 104703, improving Table 7.2's 104831 by 128. $n=49$ still 7 holes; q9 recovers the 2003 Kaikkonen–Rosendahl 51-set, shows 51 and 50 are not lifts of the $r=8$ record in any of the 174251 quotients, and exhaustively rules out 271127 of the 279034 single-block shrinks of the 50-set with block width $\le 12$. q10 prescribes an automorphism instead of perturbing the 50: order 7 is settled at $r=10$ for every fixed-space dimension, and with orders 11, 17, 31, 73, 127 also excluded, any 49-set has a $\{2,3,5\}$-group of automorphisms. At $r=11$ no invariant set below the record 79 exists for orders 11, 17 or 23. q11 adds a fibered "graph plus kernel" family — one column over every nonzero point of a quotient, plus a kernel block — whose radius-2 condition is a line colouring of $\mathrm{PG}$; it contains the documented lengths at $r=4,7,8,9$, is exactly decided for $r\le 8$ (so it reproduces $\ell_2(8,2)\le 26$ and cannot beat it), and provably cannot produce any $n\le 47$ at $r=10$, where its own best is 54. The nearest miss is at $r=9$: $n=38$ would beat $\ell_2(9,2)\le 39$ and reduces inside the family to exactly 17 kernel-block classes, all 17 of which anneal to the same floor of 14 missing incidences and none of which the exact solver decides. q14 exhausts two local neighborhoods of the 50-set (every two-delete/one-add and three-delete/two-add switch leaves holes); $n=49$ remains open. |
...
| [unique-sum](problems/unique-sum) | Independently replayed through $p=61$, matching OEIS A398173 at 59 and 61 (the OEIS table continues through 73). Checked 15-sets and completed exclusions of every smaller size give $m(59)=15$ and $m(61)=15$. No published bound improved. |
...
| [kissing-5d](problems/kissing-5d) | All four 40-point codes (D5, L5, Q5, R5) are polar-maximal (polar max $$5/4$$). Integer Delsarte on the Q5 angles excludes size 44. Exact 3-point matrices over the rationals; no unrestricted dual below 44. The leftover (1/4)Z^5 graph has no 41-set using 22 or more D5-type points, no leftover 41-set hosted by four D5 coordinate-stars, and no leftover 41-set hosted by a type-(2,1) or type-(1,3) five-star (native CaDiCaL DRAT verified). Type-(0,5) leftover-tight SAT and leftover SAT with |U|=19 did not finish (no stored verified DRAT). The 355-point T^5 remainder has no 36-clique (native CaDiCaL DRAT verified). Range still $$40\le\tau_5\le 44$$. |
...
| [caccetta-haggkvist-k3](problems/caccetta-haggkvist-k3) | Exact CH-triangle at n=18, 21, 24, 26, 27, 29, 30, 32, 33, 35, 36 and every leftover order through n=130 (534 cubes through n=72, 1026 through n=108, 213 through n=114, 36 through n=115, 37 through n=116, 38 through n=117, 37 through n=118, 38 through n=119, 39 through n=120, 38 through n=121, 39 through n=122, 40 through n=123, 39 through n=124, 40 through n=125, 41 through n=126, 40 through n=127, 41 through n=128, 42 through n=129, then 41 through n=130, then 42 through n=131, then 43 through n=132, then 42 through n=133, then 43 through n=134, then 44 through n=135, then 43 through n=136, then 44 through n=137, then 45 through n=138, then 44 through n=139, then 45 through n=140, then 46 through n=141, then 45 through n=142, then 46 through n=143, then 47 through n=144, then 46 through n=145, then 47 through n=146, then 48 through n=147, then 47 through n=148, then 48 through n=149, then 49 through n=150, then 48 through n=151, then 49 through n=152). First remaining hole n=153. $$F_4\text{ certificate }c=0.34640\text{ (CKLS 2015 fork), below HKN }0.3465\text{ and the prior stored }0.34645.$$ Did not beat 0.3388. Conjecture 1/3 open. |
...
| [ramsey-r55](problems/ramsey-r55) | McKay 328+328 (5,5,42) graphs replayed; circulant 42/43 empty. A hypothetical 43-vertex example cannot have an automorphism of order 7, nor of cycle type 5^6 or 5^7, nor of type 5^4 with a fixed vertex meeting 0 or 4 of the 5-cycles, nor of type 5^5 with a fixed vertex meeting 2 or 3 of the 5-cycles. Leftover automorphism primes are 2, 3, and 5. Interval still $$43\le R(5,5)\le 46.$$ |
...
| [smale-tau](problems/smale-tau) | Smale 4 / Shub–Smale $\tau$-conjecture. The polynomial form has no finite record to move, so the campaign takes the integer question that Smale states in the same problem, whether $\tau(k!)\le(\log k)^c$. An exhaustive 12-step search with exact arithmetic gives $$\tau(29\#)=\tau(31\#)=12,$$ where Markström (arXiv:1306.3091) had at most 13 and 15; it replays the OEIS A217032 record through 19! and extends the A173419 table to $n\le 10266$. The 13-step decision for 20!, 21!, 22! is residue (incomplete). Exact enumeration over integer polynomials gives the largest number of distinct integer zeros at cost $k\le 6$ as 1, 1, 2, 3, 3, 4, 5. Conjecture open. |
| [hilbert16-degree-8](problems/hilbert16-degree-8) | **Number of nonempty degree-eight T-curve schemes ≥ 2,415.** Eight schemes lie outside the 2,407 baseline formed by the 2,367 certificates of arXiv:2602.06888v4, the notebook’s seventeen prior additions, ⟨3 ⊔ 1⟨3⟩ ⊔ 1⟨12⟩⟩, nine later additions, and thirteen more: ⟨1 ⊔ 1⟨1⟩ ⊔ 1⟨3⟩ ⊔ 1⟨10⟩⟩, ⟨2 ⊔ 1⟨1⟩ ⊔ 1⟨3⟩ ⊔ 1⟨10⟩⟩, ⟨1⟨1⟩ ⊔ 1⟨3⟩ ⊔ 1⟨9⟩⟩, ⟨1⟨1⟩ ⊔ 1⟨2⟩ ⊔ 1⟨10⟩⟩, ⟨1 ⊔ 1⟨1⟩ ⊔ 1⟨5⟩ ⊔ 1⟨9⟩⟩, ⟨1 ⊔ 1⟨1⟩ ⊔ 1⟨4⟩ ⊔ 1⟨10⟩⟩, ⟨1⟨1⟩ ⊔ 1⟨4⟩ ⊔ 1⟨9⟩⟩, ⟨1⟨1⟩ ⊔ 1⟨3⟩ ⊔ 1⟨10⟩⟩. Exact integer liftings and independent Python/Rust topology checks pass; [claim and certificates](problems/hilbert16-degree-8/compute/q11/CLAIM.md). Neither open maximal deep nest is decided. Hilbert 16(a) degree 8 remains open. |
...
| [simon-lieb-thirring](problems/simon-lieb-thirring) | Later record is Carvalho Corso–Ried (arXiv:2403.04347v2) $$L_{1,1,1}/L_{1,1,1}^{\mathrm{cl}}\le 1.44655\quad(M_3=0.371185695).$$ Independently the Clausen form of that value is at most 1.4465531. Did not beat 1.44655. Weidl interpolation, remainder absorption, a Neumann covering, and a 1D test-potential search also did not beat 1.44655. The 2018 FHJN trial pair was 1.456; a certified pair on this notebook still gives 1.45576 and does not beat CCR. Conjecture open. |
| [simon-ionization-excess](problems/simon-ionization-excess) | Simon 2000 #9. Replayed Lieb $2Z+1$, Nam $1.22$, and Hundertmark–Pattakos–Schulz. Remainders $2.953$, $3.892$, $3.9781$ from the $Z\ge 4$ ratio. Leading coefficient moved from printed $1.1185$ through $1.1118$, $1.1057$, $1.1035$, $1.1026$, $1.1021$, $1.1020$, $1.1017$, $1.1013$, $1.1010$, and $1.1006$ to $1.1005$. Two independent rational matrix checks prove $N_c(Z)<1.1005Z+3.933Z^{1/3}$ for $Z\ge4$; [claim and replay](problems/simon-ionization-excess/compute/q14/CLAIM.md). Hydrogen N0(1)=2 replayed. Bounded excess open. |
...
| covering redundancy-41 QM$_4^3$ lift | `problems/covering/compute/q16` | GPT-6 Sol | 2026-09-23 |
| covering redundancy-47 QM$_4^3$ lift | `problems/covering/compute/q15` | GPT-6 Sol | 2026-09-23 |
| covering 49-column local switches | `problems/covering/compute/q14` | GPT-6 Sol | 2026-09-23 |
...
| Caccetta–Häggkvist leftover holes through n=139 | `problems/caccetta-haggkvist-k3/compute/q30` | Cursor Grok 4.6 | 2026-08-28 |
| Caccetta–Häggkvist leftover holes through n=140 | `problems/caccetta-haggkvist-k3/compute/q31` | Cursor Grok 4.6 | 2026-08-28 |
| Caccetta–Häggkvist leftover holes through n=141 | `problems/caccetta-haggkvist-k3/compute/q32` | Cursor Grok 4.6 | 2026-08-28 |
| Caccetta–Häggkvist leftover holes through n=142 | `problems/caccetta-haggkvist-k3/compute/q33` | Cursor Grok 4.6 | 2026-08-28 |
| Caccetta–Häggkvist leftover holes through n=143 | `problems/caccetta-haggkvist-k3/compute/q34` | Cursor Grok 4.6 | 2026-08-28 |
| Caccetta–Häggkvist leftover holes through n=144 | `problems/caccetta-haggkvist-k3/compute/q34` | Cursor Grok 4.6 | 2026-08-28 |
| Caccetta–Häggkvist leftover holes through n=145 | `problems/caccetta-haggkvist-k3/compute/q35` | Cursor Grok 4.6 | 2026-08-28 |
| Caccetta–Häggkvist leftover holes through n=146 | `problems/caccetta-haggkvist-k3/compute/q36` | Cursor Grok 4.6 | 2026-08-29 |
| Caccetta–Häggkvist leftover holes through n=147 | `problems/caccetta-haggkvist-k3/compute/q37` | Cursor Grok 4.6 | 2026-08-29 |
| Caccetta–Häggkvist leftover holes through n=148 | `problems/caccetta-haggkvist-k3/compute/q38` | Cursor Grok 4.6 | 2026-08-29 |
| Caccetta–Häggkvist leftover holes through n=149 | `problems/caccetta-haggkvist-k3/compute/q39` | Cursor Grok 4.6 | 2026-08-29 |
| Caccetta–Häggkvist leftover holes through n=150 | `problems/caccetta-haggkvist-k3/compute/q40` | Cursor Grok 4.6 | 2026-08-29 |
| Caccetta–Häggkvist leftover holes through n=151 | `problems/caccetta-haggkvist-k3/compute/q41` | Cursor Grok 4.6 | 2026-08-29 |
...
| Hilbert 16(a) degree 8 | `problems/hilbert16-degree-8` | Fable 5, Opus 5, Grok 4.6, SuperGrok 4.6, GPT-6 Astra | 2026-08-21, 2026-08-23, 2026-08-27, 2026-08-29, 2026-09-04, 2026-09-08, 2026-09-12, 2026-09-20, 2026-09-22, 2026-09-26 |
...
| Lieb–Thirring (Simon 2000 #15) | `problems/simon-lieb-thirring` | Grok 4.6 | 2026-08-27, 2026-09-02 |
...
| Simon ionization excess | `problems/simon-ionization-excess` | Grok 4.6 | 2026-08-27, 2026-09-03 |
...
| Simon ionization excess / n=36 at aspect 10 | `problems/simon-ionization-excess/compute/q11` | Cursor Grok 4.6 | 2026-08-28 |
...
| Stop tracking bulky solver certificates | repo hygiene | Cursor Grok 4.6 | 2026-09-11 |
