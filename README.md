...
| [hadwiger-nelson-plane](problems/hadwiger-nelson-plane) | Published interval $5\le\chi(\mathbb R^2)\le7$. A 2,010-vertex exact Parts spawn combining a 677-point reserve and two rotated copies is five-colorable; its model covers every add-only subset of 1,501 distinct points. No new lower bound. |
